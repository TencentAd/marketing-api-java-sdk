...
public class UnionPositionPackagesApi {
   ...
   */
  public com.squareup.okhttp.Call unionPositionPackagesAddCall(UnionPositionPackagesAddRequest data,
  ...
  private com.squareup.okhttp.Call unionPositionPackagesAddValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<UnionPositionPackagesAddResponse> unionPositionPackagesAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<UnionPositionPackagesAddResponse>() {
    }.getType();
  ...
  public com.squareup.okhttp.Call unionPositionPackagesAddAsync(
      UnionPositionPackagesAddRequest data,
      final ApiCallback<UnionPositionPackagesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesAddValidateBeforeCall(data,
  ...
  private com.squareup.okhttp.Call unionPositionPackagesDeleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesDeleteCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public UnionPositionPackagesDeleteResponse unionPositionPackagesDelete(
    ...
    ApiResponse<UnionPositionPackagesDeleteResponse> resp = unionPositionPackagesDeleteWithHttpInfo(
        data);
    return resp.getData();
  }
  ...
  public ApiResponse<UnionPositionPackagesDeleteResponse> unionPositionPackagesDeleteWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<UnionPositionPackagesDeleteResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  public com.squareup.okhttp.Call unionPositionPackagesDeleteAsync(
      UnionPositionPackagesDeleteRequest data,
      final ApiCallback<UnionPositionPackagesDeleteResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesDeleteValidateBeforeCall(data,
        progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<UnionPositionPackagesDeleteResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call unionPositionPackagesGetCall(Long accountId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call unionPositionPackagesGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesGetCall(accountId, filtering, page,
   ...
   * response body
   */
  public UnionPositionPackagesGetResponse unionPositionPackagesGet(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<UnionPositionPackagesGetResponse> resp = unionPositionPackagesGetWithHttpInfo(
        accountId, filtering, page, pageSize, fields);
    return resp.getData();
  }
  ...
  public ApiResponse<UnionPositionPackagesGetResponse> unionPositionPackagesGetWithHttpInfo(
    ...
    com.squareup.okhttp.Call call = unionPositionPackagesGetValidateBeforeCall(accountId, filtering,
        page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<UnionPositionPackagesGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call unionPositionPackagesGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<UnionPositionPackagesGetResponse> callback) throws ApiException {
