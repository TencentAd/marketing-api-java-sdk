...
public class SplitTestsApi {
   ...
   */
  public com.squareup.okhttp.Call splitTestsAddCall(SplitTestsAddRequest data,
  ...
  private com.squareup.okhttp.Call splitTestsAddValidateBeforeCall(SplitTestsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<SplitTestsAddResponse> splitTestsAddWithHttpInfo(SplitTestsAddRequest data)
    ...
    Type localVarReturnType = new TypeToken<SplitTestsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call splitTestsAddAsync(SplitTestsAddRequest data,
      final ApiCallback<SplitTestsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<SplitTestsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call splitTestsDeleteCall(SplitTestsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call splitTestsDeleteValidateBeforeCall(SplitTestsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsDeleteCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<SplitTestsDeleteResponse> splitTestsDeleteWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<SplitTestsDeleteResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call splitTestsDeleteAsync(SplitTestsDeleteRequest data,
      final ApiCallback<SplitTestsDeleteResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsDeleteValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<SplitTestsDeleteResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call splitTestsGetCall(Long accountId, List<FilteringStruct> filtering,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call splitTestsGetValidateBeforeCall(Long accountId,
    ...
    com.squareup.okhttp.Call call = splitTestsGetCall(accountId, filtering, page, pageSize, fields,
   ...
   * response body
   */
  public SplitTestsGetResponse splitTestsGet(Long accountId, List<FilteringStruct> filtering,
      Long page, Long pageSize, List<String> fields) throws ApiException {
    ApiResponse<SplitTestsGetResponse> resp = splitTestsGetWithHttpInfo(accountId, filtering, page,
        pageSize, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<SplitTestsGetResponse> splitTestsGetWithHttpInfo(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = splitTestsGetValidateBeforeCall(accountId, filtering, page,
        pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<SplitTestsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call splitTestsGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<SplitTestsGetResponse> callback) throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call splitTestsUpdateCall(SplitTestsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call splitTestsUpdateValidateBeforeCall(SplitTestsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsUpdateCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<SplitTestsUpdateResponse> splitTestsUpdateWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<SplitTestsUpdateResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call splitTestsUpdateAsync(SplitTestsUpdateRequest data,
      final ApiCallback<SplitTestsUpdateResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = splitTestsUpdateValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<SplitTestsUpdateResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
