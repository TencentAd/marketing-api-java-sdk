...
public class UserPropertiesApi {
   ...
   */
  public com.squareup.okhttp.Call userPropertiesAddCall(UserPropertiesAddRequest data,
  ...
  private com.squareup.okhttp.Call userPropertiesAddValidateBeforeCall(
      UserPropertiesAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = userPropertiesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<UserPropertiesAddResponse> userPropertiesAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<UserPropertiesAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call userPropertiesAddAsync(UserPropertiesAddRequest data,
      final ApiCallback<UserPropertiesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = userPropertiesAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<UserPropertiesAddResponse>() {
    }.getType();
