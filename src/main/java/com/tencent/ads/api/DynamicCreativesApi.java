...
public class DynamicCreativesApi {
   ...
   */
  public com.squareup.okhttp.Call dynamicCreativesAddCall(DynamicCreativesAddRequest data,
  ...
  private com.squareup.okhttp.Call dynamicCreativesAddValidateBeforeCall(
      DynamicCreativesAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicCreativesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<DynamicCreativesAddResponse> dynamicCreativesAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<DynamicCreativesAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call dynamicCreativesAddAsync(DynamicCreativesAddRequest data,
      final ApiCallback<DynamicCreativesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicCreativesAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<DynamicCreativesAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call dynamicCreativesGetCall(Long accountId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call dynamicCreativesGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicCreativesGetCall(accountId, filtering, page, pageSize,
   ...
   * response body
   */
  public DynamicCreativesGetResponse dynamicCreativesGet(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<DynamicCreativesGetResponse> resp = dynamicCreativesGetWithHttpInfo(accountId,
   ...
   * response body
   */
  public ApiResponse<DynamicCreativesGetResponse> dynamicCreativesGetWithHttpInfo(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = dynamicCreativesGetValidateBeforeCall(accountId, filtering,
        page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<DynamicCreativesGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call dynamicCreativesGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<DynamicCreativesGetResponse> callback) throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call dynamicCreativesUpdateCall(DynamicCreativesUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  private com.squareup.okhttp.Call dynamicCreativesUpdateValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = dynamicCreativesUpdateCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<DynamicCreativesUpdateResponse> dynamicCreativesUpdateWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<DynamicCreativesUpdateResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call dynamicCreativesUpdateAsync(DynamicCreativesUpdateRequest data,
      final ApiCallback<DynamicCreativesUpdateResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicCreativesUpdateValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<DynamicCreativesUpdateResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
