...
public class ComplianceValidationApi {
   ...
   */
  public com.squareup.okhttp.Call complianceValidationGetCall(ComplianceValidationGetRequest data,
  ...
  private com.squareup.okhttp.Call complianceValidationGetValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = complianceValidationGetCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<ComplianceValidationGetResponse> complianceValidationGetWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<ComplianceValidationGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call complianceValidationGetAsync(ComplianceValidationGetRequest data,
      final ApiCallback<ComplianceValidationGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = complianceValidationGetValidateBeforeCall(data,
