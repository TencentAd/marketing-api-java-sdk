...
public class DynamicAdImagesApi {
   ...
   */
  public com.squareup.okhttp.Call dynamicAdImagesAddCall(DynamicAdImagesAddRequest data,
  ...
  private com.squareup.okhttp.Call dynamicAdImagesAddValidateBeforeCall(
      DynamicAdImagesAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicAdImagesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<DynamicAdImagesAddResponse> dynamicAdImagesAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<DynamicAdImagesAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call dynamicAdImagesAddAsync(DynamicAdImagesAddRequest data,
      final ApiCallback<DynamicAdImagesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicAdImagesAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<DynamicAdImagesAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call dynamicAdImagesGetCall(Long accountId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call dynamicAdImagesGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = dynamicAdImagesGetCall(accountId, filtering, page, pageSize,
   ...
   * response body
   */
  public DynamicAdImagesGetResponse dynamicAdImagesGet(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<DynamicAdImagesGetResponse> resp = dynamicAdImagesGetWithHttpInfo(accountId,
   ...
   * response body
   */
  public ApiResponse<DynamicAdImagesGetResponse> dynamicAdImagesGetWithHttpInfo(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = dynamicAdImagesGetValidateBeforeCall(accountId, filtering, page,
        pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<DynamicAdImagesGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call dynamicAdImagesGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<DynamicAdImagesGetResponse> callback) throws ApiException {
