...
public class ConversionLinksApi {
  private ApiClient apiClient;

  public ConversionLinksApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public ConversionLinksApi(ApiClient apiClient) {
  ...
  /**
   * Build call for conversionLinksGet
   *
  ...
  public com.squareup.okhttp.Call conversionLinksGetCall(
    ...
    String localVarPath = "/conversion_links/get";
  ...
  private com.squareup.okhttp.Call conversionLinksGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling conversionLinksGet(Async)");
    }

    // verify the required parameter 'secondCategoryType' is set
    if (secondCategoryType == null) {
      throw new ApiException(
          "Missing the required parameter 'secondCategoryType' when calling conversionLinksGet(Async)");
    }
