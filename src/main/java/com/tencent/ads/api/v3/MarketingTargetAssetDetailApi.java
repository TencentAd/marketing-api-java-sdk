...
import com.tencent.ads.model.v3.MarketingTargetAssetDetailGetResponse;
...
public class MarketingTargetAssetDetailApi {
  private ApiClient apiClient;

  public MarketingTargetAssetDetailApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public MarketingTargetAssetDetailApi(ApiClient apiClient) {
  ...
  public com.squareup.okhttp.Call marketingTargetAssetDetailGetCall(
    ...
    String localVarPath = "/marketing_target_asset_detail/get";
  ...
  private com.squareup.okhttp.Call marketingTargetAssetDetailGetValidateBeforeCall(
    ...
    if (marketingAssetId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketingAssetId' when calling marketingTargetAssetDetailGet(Async)");
    }

    // verify the required parameter 'marketingTargetType' is set
    if (marketingTargetType == null) {
      throw new ApiException(
          "Missing the required parameter 'marketingTargetType' when calling marketingTargetAssetDetailGet(Async)");
    }
