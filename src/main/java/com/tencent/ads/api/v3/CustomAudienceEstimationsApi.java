...
public class CustomAudienceEstimationsApi {
  ...
  public com.squareup.okhttp.Call customAudienceEstimationsGetCall(
    ...
    if (audienceSpec != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("audience_spec", audienceSpec));
    if (fields != null)
  ...
  private com.squareup.okhttp.Call customAudienceEstimationsGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling customAudienceEstimationsGet(Async)");
    }

    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(
          "Missing the required parameter 'type' when calling customAudienceEstimationsGet(Async)");
    }

    // verify the required parameter 'audienceSpec' is set
    if (audienceSpec == null) {
      throw new ApiException(
          "Missing the required parameter 'audienceSpec' when calling customAudienceEstimationsGet(Async)");
    }
  ...
  public ApiResponse<CustomAudienceEstimationsGetResponse> customAudienceEstimationsGetWithHttpInfo(
    ...
    com.squareup.okhttp.Call call =
        customAudienceEstimationsGetValidateBeforeCall(
            accountId, type, audienceSpec, fields, null, null, headerPair);
