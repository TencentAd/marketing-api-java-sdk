...
public class AgencyWalletListApi {
  private ApiClient apiClient;

  public AgencyWalletListApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public AgencyWalletListApi(ApiClient apiClient) {
  ...
  public com.squareup.okhttp.Call agencyWalletListGetCall(
    ...
    String localVarPath = "/agency_wallet_list/get";
   ...
   * @param walletId (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;AgencyWalletListGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call agencyWalletListGetAsync(
      ...
      Long walletId,
      List<String> fields,
      final ApiCallback<AgencyWalletListGetResponse> callback,
      Pair... headerPair)
      throws ApiException {
