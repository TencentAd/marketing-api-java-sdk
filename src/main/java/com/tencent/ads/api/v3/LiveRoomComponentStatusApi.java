...
public class LiveRoomComponentStatusApi {
  private ApiClient apiClient;

  public LiveRoomComponentStatusApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public LiveRoomComponentStatusApi(ApiClient apiClient) {
  ...
  /**
   * Build call for liveRoomComponentStatusUpdate
   *
   * @param data (required)
   ...
   */
  public com.squareup.okhttp.Call liveRoomComponentStatusUpdateCall(
    ...
    String localVarPath = "/live_room_component_status/update";
  ...
  private com.squareup.okhttp.Call liveRoomComponentStatusUpdateValidateBeforeCall(
      LiveRoomComponentStatusUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      String... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling liveRoomComponentStatusUpdate(Async)");
    }

    com.squareup.okhttp.Call call =
        liveRoomComponentStatusUpdateCall(
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;LiveRoomComponentStatusUpdateResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call liveRoomComponentStatusUpdateAsync(
    ...
    com.squareup.okhttp.Call call =
        liveRoomComponentStatusUpdateValidateBeforeCall(
            data, progressListener, progressRequestListener, headerPair);
    Type localVarReturnType = new TypeToken<LiveRoomComponentStatusUpdateResponse>() {}.getType();
