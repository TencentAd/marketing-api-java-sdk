...
public class WalletGetBindingAdvertiserApi {
  private ApiClient apiClient;

  public WalletGetBindingAdvertiserApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public WalletGetBindingAdvertiserApi(ApiClient apiClient) {
  ...
  /**
   * Build call for walletGetBindingAdvertiserGet
   *
  ...
  public com.squareup.okhttp.Call walletGetBindingAdvertiserGetCall(
    ...
    String localVarPath = "/wallet_get_binding_advertiser/get";
  ...
  private com.squareup.okhttp.Call walletGetBindingAdvertiserGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling walletGetBindingAdvertiserGet(Async)");
    }
  ...
  /**
   * 查询单个共享钱包下的关联账户信息 (asynchronously)
   *
   * @param accountId (required)
   * @param walletId (required)
   * @param page (required)
