...
public class FundTransferApi {
   ...
   *     response body
   */
  public FundTransferAddResponse fundTransferAdd(FundTransferAddRequest data, Pair... headerPair)
      throws ApiException {
  ...
  public ApiResponse<FundTransferAddResponse> fundTransferAddWithHttpInfo(
      FundTransferAddRequest data, Pair... headerPair) throws ApiException {
