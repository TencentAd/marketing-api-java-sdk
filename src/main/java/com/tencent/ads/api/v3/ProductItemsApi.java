...
public class ProductItemsApi {
  ...
  /**
   * Build call for productItemsDelete
   *
   * @param data (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call productItemsDeleteCall(
      ProductItemsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      Pair... headerPair)
      throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/product_items/delete";
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call productItemsDeleteValidateBeforeCall(
      ProductItemsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      Pair... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling productItemsDelete(Async)");
    }

    com.squareup.okhttp.Call call =
        productItemsDeleteCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
  ...
  public ProductItemsDeleteResponse productItemsDelete(
      ProductItemsDeleteRequest data, Pair... headerPair) throws ApiException {
    ApiResponse<ProductItemsDeleteResponse> resp = productItemsDeleteWithHttpInfo(data, headerPair);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;ProductItemsDeleteResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<ProductItemsDeleteResponse> productItemsDeleteWithHttpInfo(
      ProductItemsDeleteRequest data, Pair... headerPair) throws ApiException {
    com.squareup.okhttp.Call call =
        productItemsDeleteValidateBeforeCall(data, null, null, headerPair);
    Type localVarReturnType = new TypeToken<ProductItemsDeleteResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * 删除商品信息 (asynchronously)
   *
   * @param data (required)
   * @param callback The callback to be executed when the API call finishes
   * @return The request call
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call productItemsDeleteAsync(
      ProductItemsDeleteRequest data,
      final ApiCallback<ProductItemsDeleteResponse> callback,
      Pair... headerPair)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call =
        productItemsDeleteValidateBeforeCall(
            data, progressListener, progressRequestListener, headerPair);
    Type localVarReturnType = new TypeToken<ProductItemsDeleteResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
