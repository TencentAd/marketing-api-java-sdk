  ...
  private com.squareup.okhttp.Call businessPointGetValidateBeforeCall(
    ...
    if (siteSets == null) {
      throw new ApiException(
          "Missing the required parameter 'siteSets' when calling businessPointGet(Async)");
    }

    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling businessPointGet(Async)");
    }

    com.squareup.okhttp.Call call =
        businessPointGetCall(
            siteSets, accountId, fields, progressListener, progressRequestListener, headerPair);
    return call;
  }
