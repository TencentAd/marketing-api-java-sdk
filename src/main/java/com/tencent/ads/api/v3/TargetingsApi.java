...
public class TargetingsApi {
  ...
  private com.squareup.okhttp.Call targetingsGetValidateBeforeCall(
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling targetingsGet(Async)");
    }

    com.squareup.okhttp.Call call =
        targetingsGetCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
   ...
   *     response body
   */
  public TargetingsGetResponse targetingsGet(TargetingsGetRequest data, String... headerPair)
      throws ApiException {
    ApiResponse<TargetingsGetResponse> resp = targetingsGetWithHttpInfo(data, headerPair);
    return resp.getData();
  }
  ...
  public ApiResponse<TargetingsGetResponse> targetingsGetWithHttpInfo(
      TargetingsGetRequest data, String... headerPair) throws ApiException {
    com.squareup.okhttp.Call call = targetingsGetValidateBeforeCall(data, null, null, headerPair);
    Type localVarReturnType = new TypeToken<TargetingsGetResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * 获取定向模板 (asynchronously)
   *
   * @param data (required)
