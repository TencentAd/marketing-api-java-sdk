...
import com.tencent.ads.model.v3.ComponentDependsGetResponse;
...
public class ComponentDependsApi {
  private ApiClient apiClient;

  public ComponentDependsApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public ComponentDependsApi(ApiClient apiClient) {
  ...
  /**
   * Build call for componentDependsGet
   *
   ...
   */
  public com.squareup.okhttp.Call componentDependsGetCall(
      Long accountId,
    ...
    String localVarPath = "/component_depends/get";
  ...
  private com.squareup.okhttp.Call componentDependsGetValidateBeforeCall(
      Long accountId,
      String marketingGoal,
      String marketingTargetType,
      String marketingCarrierType,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling componentDependsGet(Async)");
    }

    // verify the required parameter 'marketingGoal' is set
    if (marketingGoal == null) {
      throw new ApiException(
          "Missing the required parameter 'marketingGoal' when calling componentDependsGet(Async)");
    }

    // verify the required parameter 'marketingTargetType' is set
    if (marketingTargetType == null) {
      throw new ApiException(
          "Missing the required parameter 'marketingTargetType' when calling componentDependsGet(Async)");
    }

    // verify the required parameter 'marketingCarrierType' is set
    if (marketingCarrierType == null) {
      throw new ApiException(
          "Missing the required parameter 'marketingCarrierType' when calling componentDependsGet(Async)");
    }

    // verify the required parameter 'deliveryMode' is set
    if (deliveryMode == null) {
      throw new ApiException(
          "Missing the required parameter 'deliveryMode' when calling componentDependsGet(Async)");
    }

    com.squareup.okhttp.Call call =
        componentDependsGetCall(
            accountId,
            marketingGoal,
            marketingTargetType,
   ...
   *     response body
   */
  public ComponentDependsGetResponse componentDependsGet(
      Long accountId,
      String marketingGoal,
      String marketingTargetType,
      String marketingCarrierType,
      ...
      Pair... headerPair)
      throws ApiException {
    ApiResponse<ComponentDependsGetResponse> resp =
        componentDependsGetWithHttpInfo(
            accountId,
            marketingGoal,
            marketingTargetType,
            marketingCarrierType,
   ...
   * @param componentType (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;ComponentDependsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<ComponentDependsGetResponse> componentDependsGetWithHttpInfo(
      Long accountId,
      String marketingGoal,
      String marketingTargetType,
      String marketingCarrierType,
      ...
      throws ApiException {
    com.squareup.okhttp.Call call =
        componentDependsGetValidateBeforeCall(
            accountId,
            marketingGoal,
            marketingTargetType,
            marketingCarrierType,
            ...
            null,
            headerPair);
    Type localVarReturnType = new TypeToken<ComponentDependsGetResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * 查询创意组件字段选项对于其他组件的依赖信息 (asynchronously)
   *
   * @param accountId (required)
   * @param marketingGoal (required)
   * @param marketingTargetType (required)
   ...
   */
  public com.squareup.okhttp.Call componentDependsGetAsync(
      Long accountId,
      String marketingGoal,
      String marketingTargetType,
      String marketingCarrierType,
      ...
      String componentType,
      List<String> fields,
      final ApiCallback<ComponentDependsGetResponse> callback,
      Pair... headerPair)
      throws ApiException {
