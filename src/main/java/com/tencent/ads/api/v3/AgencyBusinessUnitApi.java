...
public class AgencyBusinessUnitApi {
  private ApiClient apiClient;

  public AgencyBusinessUnitApi() {
    this(Configuration.getV3DefaultApiClient());
  }

  public AgencyBusinessUnitApi(ApiClient apiClient) {
  ...
  /**
   * Build call for agencyBusinessUnitAdd
   *
   * @param data (required)
   ...
   */
  public com.squareup.okhttp.Call agencyBusinessUnitAddCall(
    ...
    String localVarPath = "/agency_business_unit/add";
  ...
  private com.squareup.okhttp.Call agencyBusinessUnitAddValidateBeforeCall(
      AgencyBusinessUnitAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      String... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling agencyBusinessUnitAdd(Async)");
    }

    com.squareup.okhttp.Call call =
        agencyBusinessUnitAddCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;AgencyBusinessUnitAddResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call agencyBusinessUnitAddAsync(
    ...
    com.squareup.okhttp.Call call =
        agencyBusinessUnitAddValidateBeforeCall(
  ...
  /**
   * Build call for agencyBusinessUnitUpdate
   *
   * @param data (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call agencyBusinessUnitUpdateCall(
    ...
    // create path and map variables
    String localVarPath = "/agency_business_unit/update";
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call agencyBusinessUnitUpdateValidateBeforeCall(
      AgencyBusinessUnitUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      String... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling agencyBusinessUnitUpdate(Async)");
    }

    com.squareup.okhttp.Call call =
        agencyBusinessUnitUpdateCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;AgencyBusinessUnitUpdateResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call agencyBusinessUnitUpdateAsync(
    ...
    com.squareup.okhttp.Call call =
        agencyBusinessUnitUpdateValidateBeforeCall(
            data, progressListener, progressRequestListener, headerPair);
    Type localVarReturnType = new TypeToken<AgencyBusinessUnitUpdateResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
