...
public class BidwordFlowApi {
  ...
  public com.squareup.okhttp.Call bidwordFlowGetCall(
    ...
    if (bidwordList != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("multi", "bidword_list", bidwordList));
    if (orderBy != null)
      localVarCollectionQueryParams.addAll(
  ...
  private com.squareup.okhttp.Call bidwordFlowGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling bidwordFlowGet(Async)");
    }

    // verify the required parameter 'bidwordList' is set
    if (bidwordList == null) {
      throw new ApiException(
          "Missing the required parameter 'bidwordList' when calling bidwordFlowGet(Async)");
    }
   ...
   *     response body
   */
  public BidwordFlowGetResponse bidwordFlowGet(
      Long accountId,
      List<String> bidwordList,
      List<OrderByStructInfo> orderBy,
      List<String> fields,
      String... headerPair)
      throws ApiException {
    ApiResponse<BidwordFlowGetResponse> resp =
        bidwordFlowGetWithHttpInfo(accountId, bidwordList, orderBy, fields, headerPair);
    return resp.getData();
  }
  ...
  public ApiResponse<BidwordFlowGetResponse> bidwordFlowGetWithHttpInfo(
    ...
    com.squareup.okhttp.Call call =
        bidwordFlowGetValidateBeforeCall(
            accountId, bidwordList, orderBy, fields, null, null, headerPair);
