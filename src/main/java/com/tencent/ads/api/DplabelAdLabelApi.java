...
public class DplabelAdLabelApi {
   ...
   *     response body
   */
  public DplabelAdLabelGetResponse dplabelAdLabelGet(
      Long accountId, List<String> fields, String... headerPair) throws ApiException {
    ApiResponse<DplabelAdLabelGetResponse> resp =
        dplabelAdLabelGetWithHttpInfo(accountId, fields, headerPair);
    return resp.getData();
  }
  ...
  public ApiResponse<DplabelAdLabelGetResponse> dplabelAdLabelGetWithHttpInfo(
      Long accountId, List<String> fields, String... headerPair) throws ApiException {
    com.squareup.okhttp.Call call =
        dplabelAdLabelGetValidateBeforeCall(accountId, fields, null, null, headerPair);
