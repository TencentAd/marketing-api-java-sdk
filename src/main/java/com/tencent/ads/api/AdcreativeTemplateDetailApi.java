...
public class AdcreativeTemplateDetailApi {
   ...
   */
  public com.squareup.okhttp.Call adcreativeTemplateDetailGetCall(Long adcreativeTemplateId,
      String promotedObjectType, Long accountId, Boolean automaticSiteEnabled, List<String> siteSet,
      Boolean isDynamicCreativeAd, List<String> fields,
    ...
    if (adcreativeTemplateId != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("adcreative_template_id", adcreativeTemplateId));
    }
    if (promotedObjectType != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("promoted_object_type", promotedObjectType));
    }
    if (accountId != null) {
    ...
    if (automaticSiteEnabled != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("automatic_site_enabled", automaticSiteEnabled));
    }
    if (siteSet != null) {
      localVarCollectionQueryParams
          .addAll(apiClient.parameterToPairs("multi", "site_set", siteSet));
    }
    if (isDynamicCreativeAd != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("is_dynamic_creative_ad", isDynamicCreativeAd));
    }
    if (fields != null) {
  ...
  private com.squareup.okhttp.Call adcreativeTemplateDetailGetValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = adcreativeTemplateDetailGetCall(adcreativeTemplateId,
        promotedObjectType, accountId, automaticSiteEnabled, siteSet, isDynamicCreativeAd, fields,
   ...
   * response body
   */
  public AdcreativeTemplateDetailGetResponse adcreativeTemplateDetailGet(Long adcreativeTemplateId,
      String promotedObjectType, Long accountId, Boolean automaticSiteEnabled, List<String> siteSet,
      Boolean isDynamicCreativeAd, List<String> fields) throws ApiException {
    ApiResponse<AdcreativeTemplateDetailGetResponse> resp = adcreativeTemplateDetailGetWithHttpInfo(
        adcreativeTemplateId, promotedObjectType, accountId, automaticSiteEnabled, siteSet,
        isDynamicCreativeAd, fields);
    return resp.getData();
  }
  ...
  public ApiResponse<AdcreativeTemplateDetailGetResponse> adcreativeTemplateDetailGetWithHttpInfo(
    ...
    com.squareup.okhttp.Call call = adcreativeTemplateDetailGetValidateBeforeCall(
        adcreativeTemplateId, promotedObjectType, accountId, automaticSiteEnabled, siteSet,
        isDynamicCreativeAd, fields, null, null);
    Type localVarReturnType = new TypeToken<AdcreativeTemplateDetailGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call adcreativeTemplateDetailGetAsync(Long adcreativeTemplateId,
      String promotedObjectType, Long accountId, Boolean automaticSiteEnabled, List<String> siteSet,
      Boolean isDynamicCreativeAd, List<String> fields,
      final ApiCallback<AdcreativeTemplateDetailGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = adcreativeTemplateDetailGetValidateBeforeCall(
        adcreativeTemplateId, promotedObjectType, accountId, automaticSiteEnabled, siteSet,
        isDynamicCreativeAd, fields, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<AdcreativeTemplateDetailGetResponse>() {
    }.getType();
