...
public class RealtimeCostApi {
   ...
   */
  public com.squareup.okhttp.Call realtimeCostGetCall(Long accountId, String level, String date,
  ...
  private com.squareup.okhttp.Call realtimeCostGetValidateBeforeCall(Long accountId, String level,
      String date, List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = realtimeCostGetCall(accountId, level, date, filtering, page,
   ...
   * response body
   */
  public RealtimeCostGetResponse realtimeCostGet(Long accountId, String level, String date,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<RealtimeCostGetResponse> resp = realtimeCostGetWithHttpInfo(accountId, level, date,
   ...
   * response body
   */
  public ApiResponse<RealtimeCostGetResponse> realtimeCostGetWithHttpInfo(Long accountId,
      String level, String date, List<FilteringStruct> filtering, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = realtimeCostGetValidateBeforeCall(accountId, level, date,
        filtering, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<RealtimeCostGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call realtimeCostGetAsync(Long accountId, String level, String date,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<RealtimeCostGetResponse> callback) throws ApiException {
