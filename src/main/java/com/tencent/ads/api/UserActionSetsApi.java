...
public class UserActionSetsApi {
   ...
   */
  public com.squareup.okhttp.Call userActionSetsAddCall(UserActionSetsAddRequest data,
  ...
  private com.squareup.okhttp.Call userActionSetsAddValidateBeforeCall(
      UserActionSetsAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = userActionSetsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<UserActionSetsAddResponse> userActionSetsAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<UserActionSetsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call userActionSetsAddAsync(UserActionSetsAddRequest data,
      final ApiCallback<UserActionSetsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = userActionSetsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<UserActionSetsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call userActionSetsGetCall(Long accountId, Long userActionSetId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call userActionSetsGetValidateBeforeCall(Long accountId,
      Long userActionSetId, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = userActionSetsGetCall(accountId, userActionSetId, fields,
   ...
   * response body
   */
  public UserActionSetsGetResponse userActionSetsGet(Long accountId, Long userActionSetId,
      List<String> fields) throws ApiException {
    ApiResponse<UserActionSetsGetResponse> resp = userActionSetsGetWithHttpInfo(accountId,
        userActionSetId, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<UserActionSetsGetResponse> userActionSetsGetWithHttpInfo(Long accountId,
      Long userActionSetId, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = userActionSetsGetValidateBeforeCall(accountId, userActionSetId,
        fields, null, null);
    Type localVarReturnType = new TypeToken<UserActionSetsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call userActionSetsGetAsync(Long accountId, Long userActionSetId,
      List<String> fields, final ApiCallback<UserActionSetsGetResponse> callback)
      throws ApiException {
