...
public class ProductCatalogsApi {
   ...
   */
  public com.squareup.okhttp.Call productCatalogsAddCall(ProductCatalogsAddRequest data,
  ...
  private com.squareup.okhttp.Call productCatalogsAddValidateBeforeCall(
      ProductCatalogsAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = productCatalogsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<ProductCatalogsAddResponse> productCatalogsAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<ProductCatalogsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call productCatalogsAddAsync(ProductCatalogsAddRequest data,
      final ApiCallback<ProductCatalogsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = productCatalogsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<ProductCatalogsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call productCatalogsGetCall(Long accountId, Long page, Long pageSize,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call productCatalogsGetValidateBeforeCall(Long accountId, Long page,
    ...
    com.squareup.okhttp.Call call = productCatalogsGetCall(accountId, page, pageSize, fields,
   ...
   * response body
   */
  public ProductCatalogsGetResponse productCatalogsGet(Long accountId, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    ApiResponse<ProductCatalogsGetResponse> resp = productCatalogsGetWithHttpInfo(accountId, page,
        pageSize, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<ProductCatalogsGetResponse> productCatalogsGetWithHttpInfo(Long accountId,
      Long page, Long pageSize, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = productCatalogsGetValidateBeforeCall(accountId, page, pageSize,
        fields, null, null);
    Type localVarReturnType = new TypeToken<ProductCatalogsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call productCatalogsGetAsync(Long accountId, Long page, Long pageSize,
      List<String> fields, final ApiCallback<ProductCatalogsGetResponse> callback)
      throws ApiException {
