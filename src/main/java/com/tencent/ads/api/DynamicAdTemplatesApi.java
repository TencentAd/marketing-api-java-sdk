...
public class DynamicAdTemplatesApi {
   ...
   */
  public com.squareup.okhttp.Call dynamicAdTemplatesGetCall(Long accountId, Long productCatalogId,
      Long dynamicAdTemplateWidth, Long dynamicAdTemplateHeight, String dynamicAdTemplateType,
      String dynamicAdTemplateOwnershipType, List<FilteringStruct> filtering, Long page,
      Long pageSize, List<String> fields,
    ...
    if (dynamicAdTemplateType != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("dynamic_ad_template_type", dynamicAdTemplateType));
    }
    if (dynamicAdTemplateOwnershipType != null) {
      localVarQueryParams.addAll(apiClient
          .parameterToPair("dynamic_ad_template_ownership_type", dynamicAdTemplateOwnershipType));
    }
    if (dynamicAdTemplateWidth != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("dynamic_ad_template_width", dynamicAdTemplateWidth));
    }
    if (dynamicAdTemplateHeight != null) {
      localVarQueryParams
          .addAll(apiClient.parameterToPair("dynamic_ad_template_height", dynamicAdTemplateHeight));
    }
    if (filtering != null) {
  ...
  private com.squareup.okhttp.Call dynamicAdTemplatesGetValidateBeforeCall(Long accountId,
    ...
    com.squareup.okhttp.Call call = dynamicAdTemplatesGetCall(accountId, productCatalogId,
        dynamicAdTemplateWidth, dynamicAdTemplateHeight, dynamicAdTemplateType,
        dynamicAdTemplateOwnershipType, filtering, page, pageSize, fields, progressListener,
        progressRequestListener);
    return call;
   ...
   * response body
   */
  public DynamicAdTemplatesGetResponse dynamicAdTemplatesGet(Long accountId, Long productCatalogId,
      Long dynamicAdTemplateWidth, Long dynamicAdTemplateHeight, String dynamicAdTemplateType,
      String dynamicAdTemplateOwnershipType, List<FilteringStruct> filtering, Long page,
      Long pageSize, List<String> fields) throws ApiException {
    ApiResponse<DynamicAdTemplatesGetResponse> resp = dynamicAdTemplatesGetWithHttpInfo(accountId,
        productCatalogId, dynamicAdTemplateWidth, dynamicAdTemplateHeight, dynamicAdTemplateType,
        dynamicAdTemplateOwnershipType, filtering, page, pageSize, fields);
    return resp.getData();
  }
  ...
  public ApiResponse<DynamicAdTemplatesGetResponse> dynamicAdTemplatesGetWithHttpInfo(
      Long accountId, Long productCatalogId, Long dynamicAdTemplateWidth,
      Long dynamicAdTemplateHeight, String dynamicAdTemplateType,
      String dynamicAdTemplateOwnershipType, List<FilteringStruct> filtering, Long page,
      Long pageSize, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = dynamicAdTemplatesGetValidateBeforeCall(accountId,
        productCatalogId, dynamicAdTemplateWidth, dynamicAdTemplateHeight, dynamicAdTemplateType,
        dynamicAdTemplateOwnershipType, filtering, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<DynamicAdTemplatesGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call dynamicAdTemplatesGetAsync(Long accountId, Long productCatalogId,
      Long dynamicAdTemplateWidth, Long dynamicAdTemplateHeight, String dynamicAdTemplateType,
      String dynamicAdTemplateOwnershipType, List<FilteringStruct> filtering, Long page,
      Long pageSize, List<String> fields, final ApiCallback<DynamicAdTemplatesGetResponse> callback)
      throws ApiException {
