...
public class LabelAudiencesApi {
   ...
   */
  public com.squareup.okhttp.Call labelAudiencesAddCall(LabelAudiencesAddRequest data,
  ...
  private com.squareup.okhttp.Call labelAudiencesAddValidateBeforeCall(
      LabelAudiencesAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = labelAudiencesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<LabelAudiencesAddResponse> labelAudiencesAddWithHttpInfo(
    ...
    com.squareup.okhttp.Call call = labelAudiencesAddValidateBeforeCall(data, null, null);
    Type localVarReturnType = new TypeToken<LabelAudiencesAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call labelAudiencesAddAsync(LabelAudiencesAddRequest data,
      final ApiCallback<LabelAudiencesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = labelAudiencesAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<LabelAudiencesAddResponse>() {
    }.getType();
