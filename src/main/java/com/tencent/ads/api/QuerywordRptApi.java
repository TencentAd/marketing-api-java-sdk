...
public class QuerywordRptApi {
   ...
   *     response body
   */
  public QuerywordRptGetResponse querywordRptGet(QuerywordRptGetRequest data, Pair... headerPair)
      throws ApiException {
  ...
  public ApiResponse<QuerywordRptGetResponse> querywordRptGetWithHttpInfo(
      QuerywordRptGetRequest data, Pair... headerPair) throws ApiException {
