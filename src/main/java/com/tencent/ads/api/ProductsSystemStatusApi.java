...
public class ProductsSystemStatusApi {
   ...
   */
  public com.squareup.okhttp.Call productsSystemStatusGetCall(Long accountId, Long productCatalogId,
      Long feedId, Long page, Long pageSize, List<String> fields,
    ...
    if (feedId != null) {
      localVarQueryParams.addAll(apiClient.parameterToPair("feed_id", feedId));
    }
    if (page != null) {
  ...
  private com.squareup.okhttp.Call productsSystemStatusGetValidateBeforeCall(Long accountId,
      Long productCatalogId, Long feedId, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = productsSystemStatusGetCall(accountId, productCatalogId, feedId,
   ...
   * response body
   */
  public ProductsSystemStatusGetResponse productsSystemStatusGet(Long accountId,
      Long productCatalogId, Long feedId, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<ProductsSystemStatusGetResponse> resp = productsSystemStatusGetWithHttpInfo(
  ...
  public ApiResponse<ProductsSystemStatusGetResponse> productsSystemStatusGetWithHttpInfo(
      Long accountId, Long productCatalogId, Long feedId, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = productsSystemStatusGetValidateBeforeCall(accountId,
        productCatalogId, feedId, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<ProductsSystemStatusGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call productsSystemStatusGetAsync(Long accountId,
      Long productCatalogId, Long feedId, Long page, Long pageSize, List<String> fields,
      final ApiCallback<ProductsSystemStatusGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = productsSystemStatusGetValidateBeforeCall(accountId,
        productCatalogId, feedId, page, pageSize, fields, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<ProductsSystemStatusGetResponse>() {
    }.getType();
