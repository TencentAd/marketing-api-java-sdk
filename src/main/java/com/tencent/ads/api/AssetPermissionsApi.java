...
public class AssetPermissionsApi {
   ...
   */
  public com.squareup.okhttp.Call assetPermissionsAddCall(AssetPermissionsAddRequest data,
  ...
  private com.squareup.okhttp.Call assetPermissionsAddValidateBeforeCall(
      AssetPermissionsAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = assetPermissionsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<AssetPermissionsAddResponse> assetPermissionsAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<AssetPermissionsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call assetPermissionsAddAsync(AssetPermissionsAddRequest data,
      final ApiCallback<AssetPermissionsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = assetPermissionsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<AssetPermissionsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call assetPermissionsDeleteCall(AssetPermissionsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  private com.squareup.okhttp.Call assetPermissionsDeleteValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = assetPermissionsDeleteCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<AssetPermissionsDeleteResponse> assetPermissionsDeleteWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<AssetPermissionsDeleteResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call assetPermissionsDeleteAsync(AssetPermissionsDeleteRequest data,
      final ApiCallback<AssetPermissionsDeleteResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = assetPermissionsDeleteValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<AssetPermissionsDeleteResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
