...
public class WechatPagesApi {
   ...
   */
  public com.squareup.okhttp.Call wechatPagesAddCall(WechatPagesAddRequest data,
  ...
  private com.squareup.okhttp.Call wechatPagesAddValidateBeforeCall(WechatPagesAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatPagesAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<WechatPagesAddResponse> wechatPagesAddWithHttpInfo(WechatPagesAddRequest data)
    ...
    Type localVarReturnType = new TypeToken<WechatPagesAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call wechatPagesAddAsync(WechatPagesAddRequest data,
      final ApiCallback<WechatPagesAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatPagesAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<WechatPagesAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call wechatPagesDeleteCall(WechatPagesDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  private com.squareup.okhttp.Call wechatPagesDeleteValidateBeforeCall(
      WechatPagesDeleteRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatPagesDeleteCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<WechatPagesDeleteResponse> wechatPagesDeleteWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<WechatPagesDeleteResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call wechatPagesDeleteAsync(WechatPagesDeleteRequest data,
      final ApiCallback<WechatPagesDeleteResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatPagesDeleteValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<WechatPagesDeleteResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call wechatPagesGetCall(Long accountId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call wechatPagesGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatPagesGetCall(accountId, filtering, page, pageSize, fields,
   ...
   * response body
   */
  public WechatPagesGetResponse wechatPagesGet(Long accountId, List<FilteringStruct> filtering,
      Long page, Long pageSize, List<String> fields) throws ApiException {
    ApiResponse<WechatPagesGetResponse> resp = wechatPagesGetWithHttpInfo(accountId, filtering,
   ...
   * response body
   */
  public ApiResponse<WechatPagesGetResponse> wechatPagesGetWithHttpInfo(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = wechatPagesGetValidateBeforeCall(accountId, filtering, page,
        pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<WechatPagesGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call wechatPagesGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<WechatPagesGetResponse> callback) throws ApiException {
