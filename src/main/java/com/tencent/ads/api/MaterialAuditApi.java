...
public class MaterialAuditApi {
  private ApiClient apiClient;

  public MaterialAuditApi() {
    this(Configuration.getDefaultApiClient());
  }

  public MaterialAuditApi(ApiClient apiClient) {
  ...
  /**
   * Build call for materialAuditList
   *
   * @param data (required)
   ...
   */
  public com.squareup.okhttp.Call materialAuditListCall(
    ...
    String localVarPath = "/material_audit/list";
  ...
  private com.squareup.okhttp.Call materialAuditListValidateBeforeCall(
      MaterialAuditListRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      String... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling materialAuditList(Async)");
    }

    com.squareup.okhttp.Call call =
        materialAuditListCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;MaterialAuditListResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call materialAuditListAsync(
    ...
    com.squareup.okhttp.Call call =
        materialAuditListValidateBeforeCall(
  ...
  /**
   * Build call for materialAuditSubmit
   *
   * @param data (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call materialAuditSubmitCall(
    ...
    // create path and map variables
    String localVarPath = "/material_audit/submit";
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call materialAuditSubmitValidateBeforeCall(
      MaterialAuditSubmitRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener,
      String... headerPair)
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling materialAuditSubmit(Async)");
    }

    com.squareup.okhttp.Call call =
        materialAuditSubmitCall(data, progressListener, progressRequestListener, headerPair);
    return call;
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;MaterialAuditSubmitResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public com.squareup.okhttp.Call materialAuditSubmitAsync(
    ...
    com.squareup.okhttp.Call call =
        materialAuditSubmitValidateBeforeCall(
            data, progressListener, progressRequestListener, headerPair);
    Type localVarReturnType = new TypeToken<MaterialAuditSubmitResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
