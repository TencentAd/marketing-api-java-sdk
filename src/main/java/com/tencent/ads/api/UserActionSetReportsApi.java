...
public class UserActionSetReportsApi {
   ...
   */
  public com.squareup.okhttp.Call userActionSetReportsGetCall(Long accountId, Long userActionSetId,
      Map<String, Object> dateRange, String timeGranularity, String aggregation,
  ...
  private com.squareup.okhttp.Call userActionSetReportsGetValidateBeforeCall(Long accountId,
      Long userActionSetId, Map<String, Object> dateRange, String timeGranularity,
      String aggregation, List<String> fields,
    ...
    com.squareup.okhttp.Call call = userActionSetReportsGetCall(accountId, userActionSetId,
        dateRange, timeGranularity, aggregation, fields, progressListener, progressRequestListener);
    return call;
   ...
   * response body
   */
  public UserActionSetReportsGetResponse userActionSetReportsGet(Long accountId,
      Long userActionSetId, Map<String, Object> dateRange, String timeGranularity,
      String aggregation, List<String> fields) throws ApiException {
    ApiResponse<UserActionSetReportsGetResponse> resp = userActionSetReportsGetWithHttpInfo(
  ...
  public ApiResponse<UserActionSetReportsGetResponse> userActionSetReportsGetWithHttpInfo(
      Long accountId, Long userActionSetId, Map<String, Object> dateRange, String timeGranularity,
      String aggregation, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = userActionSetReportsGetValidateBeforeCall(accountId,
        userActionSetId, dateRange, timeGranularity, aggregation, fields, null, null);
    Type localVarReturnType = new TypeToken<UserActionSetReportsGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call userActionSetReportsGetAsync(Long accountId, Long userActionSetId,
      Map<String, Object> dateRange, String timeGranularity, String aggregation,
      List<String> fields, final ApiCallback<UserActionSetReportsGetResponse> callback)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = userActionSetReportsGetValidateBeforeCall(accountId,
        userActionSetId, dateRange, timeGranularity, aggregation, fields, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<UserActionSetReportsGetResponse>() {
    }.getType();
