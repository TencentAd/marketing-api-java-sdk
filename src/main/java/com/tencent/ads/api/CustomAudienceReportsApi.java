...
public class CustomAudienceReportsApi {
   ...
   */
  public com.squareup.okhttp.Call customAudienceReportsGetCall(Long accountId,
      List<FilteringStruct> filtering, Map<String, Object> dateRange, List<String> groupBy,
  ...
  private com.squareup.okhttp.Call customAudienceReportsGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Map<String, Object> dateRange, List<String> groupBy,
      List<String> fields, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customAudienceReportsGetCall(accountId, filtering, dateRange,
        groupBy, fields, progressListener, progressRequestListener);
    return call;
   ...
   * response body
   */
  public CustomAudienceReportsGetResponse customAudienceReportsGet(Long accountId,
      List<FilteringStruct> filtering, Map<String, Object> dateRange, List<String> groupBy,
      List<String> fields) throws ApiException {
    ApiResponse<CustomAudienceReportsGetResponse> resp = customAudienceReportsGetWithHttpInfo(
        accountId, filtering, dateRange, groupBy, fields);
    return resp.getData();
  }
  ...
  public ApiResponse<CustomAudienceReportsGetResponse> customAudienceReportsGetWithHttpInfo(
      Long accountId, List<FilteringStruct> filtering, Map<String, Object> dateRange,
      List<String> groupBy, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = customAudienceReportsGetValidateBeforeCall(accountId, filtering,
        dateRange, groupBy, fields, null, null);
    Type localVarReturnType = new TypeToken<CustomAudienceReportsGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call customAudienceReportsGetAsync(Long accountId,
      List<FilteringStruct> filtering, Map<String, Object> dateRange, List<String> groupBy,
      List<String> fields, final ApiCallback<CustomAudienceReportsGetResponse> callback)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customAudienceReportsGetValidateBeforeCall(accountId, filtering,
        dateRange, groupBy, fields, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CustomAudienceReportsGetResponse>() {
    }.getType();
