...
public class CustomTagsApi {
   ...
   */
  public com.squareup.okhttp.Call customTagsAddCall(CustomTagsAddRequest data,
  ...
  private com.squareup.okhttp.Call customTagsAddValidateBeforeCall(CustomTagsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<CustomTagsAddResponse> customTagsAddWithHttpInfo(CustomTagsAddRequest data)
    ...
    Type localVarReturnType = new TypeToken<CustomTagsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call customTagsAddAsync(CustomTagsAddRequest data,
      final ApiCallback<CustomTagsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<CustomTagsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call customTagsDeleteCall(CustomTagsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call customTagsDeleteValidateBeforeCall(CustomTagsDeleteRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsDeleteCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<CustomTagsDeleteResponse> customTagsDeleteWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<CustomTagsDeleteResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call customTagsDeleteAsync(CustomTagsDeleteRequest data,
      final ApiCallback<CustomTagsDeleteResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsDeleteValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<CustomTagsDeleteResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call customTagsGetCall(Long accountId, Long parentTagId, Long tagId,
    ...
    if (tagCode != null) {
      localVarQueryParams.addAll(apiClient.parameterToPair("tag_code", tagCode));
    }
    if (platform != null) {
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call customTagsGetValidateBeforeCall(Long accountId, Long parentTagId,
      Long tagId, String tagCode, String platform, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsGetCall(accountId, parentTagId, tagId, tagCode,
        platform, page, pageSize, fields, progressListener, progressRequestListener);
    return call;
   ...
   * response body
   */
  public CustomTagsGetResponse customTagsGet(Long accountId, Long parentTagId, Long tagId,
      String tagCode, String platform, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<CustomTagsGetResponse> resp = customTagsGetWithHttpInfo(accountId, parentTagId,
        tagId, tagCode, platform, page, pageSize, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<CustomTagsGetResponse> customTagsGetWithHttpInfo(Long accountId,
      Long parentTagId, Long tagId, String tagCode, String platform, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = customTagsGetValidateBeforeCall(accountId, parentTagId, tagId,
        tagCode, platform, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<CustomTagsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call customTagsGetAsync(Long accountId, Long parentTagId, Long tagId,
      String tagCode, String platform, Long page, Long pageSize, List<String> fields,
      final ApiCallback<CustomTagsGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsGetValidateBeforeCall(accountId, parentTagId, tagId,
        tagCode, platform, page, pageSize, fields, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CustomTagsGetResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call customTagsUpdateCall(CustomTagsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call customTagsUpdateValidateBeforeCall(CustomTagsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsUpdateCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<CustomTagsUpdateResponse> customTagsUpdateWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<CustomTagsUpdateResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call customTagsUpdateAsync(CustomTagsUpdateRequest data,
      final ApiCallback<CustomTagsUpdateResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = customTagsUpdateValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<CustomTagsUpdateResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
