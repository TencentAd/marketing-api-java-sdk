...
public class AsyncReportsApi {
   ...
   */
  public com.squareup.okhttp.Call asyncReportsAddCall(AsyncReportsAddRequest data,
  ...
  private com.squareup.okhttp.Call asyncReportsAddValidateBeforeCall(AsyncReportsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = asyncReportsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<AsyncReportsAddResponse> asyncReportsAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<AsyncReportsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call asyncReportsAddAsync(AsyncReportsAddRequest data,
      final ApiCallback<AsyncReportsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = asyncReportsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<AsyncReportsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call asyncReportsGetCall(Long accountId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call asyncReportsGetValidateBeforeCall(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = asyncReportsGetCall(accountId, filtering, page, pageSize,
   ...
   * response body
   */
  public AsyncReportsGetResponse asyncReportsGet(Long accountId, List<FilteringStruct> filtering,
      Long page, Long pageSize, List<String> fields) throws ApiException {
    ApiResponse<AsyncReportsGetResponse> resp = asyncReportsGetWithHttpInfo(accountId, filtering,
   ...
   * response body
   */
  public ApiResponse<AsyncReportsGetResponse> asyncReportsGetWithHttpInfo(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = asyncReportsGetValidateBeforeCall(accountId, filtering, page,
        pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<AsyncReportsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call asyncReportsGetAsync(Long accountId,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<AsyncReportsGetResponse> callback) throws ApiException {
