...
public class WechatLeadsApi {
   ...
   */
  public com.squareup.okhttp.Call wechatLeadsGetCall(
      DateRange dateRange,
      TimeRange timeRange,
  ...
  private com.squareup.okhttp.Call wechatLeadsGetValidateBeforeCall(
      DateRange dateRange,
      TimeRange timeRange,
      List<FilteringStruct> filtering,
      Long page,
   ...
   *     response body
   */
  public WechatLeadsGetResponse wechatLeadsGet(
      DateRange dateRange,
      TimeRange timeRange,
      List<FilteringStruct> filtering,
      Long page,
      ...
      List<String> fields)
      throws ApiException {
    ApiResponse<WechatLeadsGetResponse> resp =
        wechatLeadsGetWithHttpInfo(dateRange, timeRange, filtering, page, pageSize, fields);
    return resp.getData();
  }
  ...
  public ApiResponse<WechatLeadsGetResponse> wechatLeadsGetWithHttpInfo(
      ...
      throws ApiException {
    com.squareup.okhttp.Call call =
        wechatLeadsGetValidateBeforeCall(
            dateRange, timeRange, filtering, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<WechatLeadsGetResponse>() {}.getType();
   ...
   */
  public com.squareup.okhttp.Call wechatLeadsGetAsync(
      DateRange dateRange,
      TimeRange timeRange,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
      List<String> fields,
      final ApiCallback<WechatLeadsGetResponse> callback)
      throws ApiException {
