...
public class FundsApi {
   ...
   */
  public com.squareup.okhttp.Call fundsGetCall(Long accountId, List<String> fields,
  ...
  private com.squareup.okhttp.Call fundsGetValidateBeforeCall(Long accountId, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = fundsGetCall(accountId, fields, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<FundsGetResponse> fundsGetWithHttpInfo(Long accountId, List<String> fields)
    ...
    Type localVarReturnType = new TypeToken<FundsGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call fundsGetAsync(Long accountId, List<String> fields,
      final ApiCallback<FundsGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = fundsGetValidateBeforeCall(accountId, fields, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<FundsGetResponse>() {
    }.getType();
