...
public class AsyncReportFilesApi {
   ...
   */
  public com.squareup.okhttp.Call asyncReportFilesGetCall(Long accountId, Long taskId, Long fileId,
  ...
  private com.squareup.okhttp.Call asyncReportFilesGetValidateBeforeCall(Long accountId,
      Long taskId, Long fileId, List<String> fields,
    ...
    com.squareup.okhttp.Call call = asyncReportFilesGetCall(accountId, taskId, fileId, fields,
  ...
  public AsyncReportFilesGetResponse asyncReportFilesGet(Long accountId, Long taskId, Long fileId,
    ...
    ApiResponse<AsyncReportFilesGetResponse> resp = asyncReportFilesGetWithHttpInfo(accountId,
        taskId, fileId, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<AsyncReportFilesGetResponse> asyncReportFilesGetWithHttpInfo(Long accountId,
      Long taskId, Long fileId, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = asyncReportFilesGetValidateBeforeCall(accountId, taskId, fileId,
        fields, null, null);
    Type localVarReturnType = new TypeToken<AsyncReportFilesGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call asyncReportFilesGetAsync(Long accountId, Long taskId, Long fileId,
      List<String> fields, final ApiCallback<AsyncReportFilesGetResponse> callback)
      throws ApiException {
