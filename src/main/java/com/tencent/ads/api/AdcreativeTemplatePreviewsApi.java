...
public class AdcreativeTemplatePreviewsApi {
  ...
  private com.squareup.okhttp.Call adcreativeTemplatePreviewsGetValidateBeforeCall(
    ...
    com.squareup.okhttp.Call call = adcreativeTemplatePreviewsGetCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public AdcreativeTemplatePreviewsGetResponse adcreativeTemplatePreviewsGet(
    ...
    ApiResponse<AdcreativeTemplatePreviewsGetResponse> resp = adcreativeTemplatePreviewsGetWithHttpInfo(
        data);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<AdcreativeTemplatePreviewsGetResponse> adcreativeTemplatePreviewsGetWithHttpInfo(
      AdcreativeTemplatePreviewsGetRequest data) throws ApiException {
    com.squareup.okhttp.Call call = adcreativeTemplatePreviewsGetValidateBeforeCall(data, null,
        null);
    Type localVarReturnType = new TypeToken<AdcreativeTemplatePreviewsGetResponse>() {
    }.getType();
  ...
  public com.squareup.okhttp.Call adcreativeTemplatePreviewsGetAsync(
      AdcreativeTemplatePreviewsGetRequest data,
      final ApiCallback<AdcreativeTemplatePreviewsGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = adcreativeTemplatePreviewsGetValidateBeforeCall(data,
