...
public class WechatFundStatementsDetailedApi {
   ...
   */
  public com.squareup.okhttp.Call wechatFundStatementsDetailedGetCall(String tradeType,
  ...
  private com.squareup.okhttp.Call wechatFundStatementsDetailedGetValidateBeforeCall(
      String tradeType, Map<String, Object> dateRange, List<FilteringStruct> filtering, Long page,
    ...
    com.squareup.okhttp.Call call = wechatFundStatementsDetailedGetCall(tradeType, dateRange,
   ...
   * response body
   */
  public WechatFundStatementsDetailedGetResponse wechatFundStatementsDetailedGet(String tradeType,
      Map<String, Object> dateRange, List<FilteringStruct> filtering, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    ApiResponse<WechatFundStatementsDetailedGetResponse> resp = wechatFundStatementsDetailedGetWithHttpInfo(
   ...
   * response body
   */
  public ApiResponse<WechatFundStatementsDetailedGetResponse> wechatFundStatementsDetailedGetWithHttpInfo(
      String tradeType, Map<String, Object> dateRange, List<FilteringStruct> filtering, Long page,
      Long pageSize, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = wechatFundStatementsDetailedGetValidateBeforeCall(tradeType,
        dateRange, filtering, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<WechatFundStatementsDetailedGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call wechatFundStatementsDetailedGetAsync(String tradeType,
      Map<String, Object> dateRange, List<FilteringStruct> filtering, Long page, Long pageSize,
      List<String> fields, final ApiCallback<WechatFundStatementsDetailedGetResponse> callback)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = wechatFundStatementsDetailedGetValidateBeforeCall(tradeType,
        dateRange, filtering, page, pageSize, fields, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<WechatFundStatementsDetailedGetResponse>() {
    }.getType();
