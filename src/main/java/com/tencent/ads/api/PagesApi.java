...
public class PagesApi {
   ...
   */
  public com.squareup.okhttp.Call pagesGetCall(Long accountId, String promotedObjectType,
  ...
  private com.squareup.okhttp.Call pagesGetValidateBeforeCall(Long accountId,
      String promotedObjectType, List<FilteringStruct> filtering, Long page, Long pageSize,
    ...
    com.squareup.okhttp.Call call = pagesGetCall(accountId, promotedObjectType, filtering, page,
   ...
   * response body
   */
  public PagesGetResponse pagesGet(Long accountId, String promotedObjectType,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields)
      throws ApiException {
    ApiResponse<PagesGetResponse> resp = pagesGetWithHttpInfo(accountId, promotedObjectType,
   ...
   * response body
   */
  public ApiResponse<PagesGetResponse> pagesGetWithHttpInfo(Long accountId,
      String promotedObjectType, List<FilteringStruct> filtering, Long page, Long pageSize,
      List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = pagesGetValidateBeforeCall(accountId, promotedObjectType,
        filtering, page, pageSize, fields, null, null);
    Type localVarReturnType = new TypeToken<PagesGetResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call pagesGetAsync(Long accountId, String promotedObjectType,
      List<FilteringStruct> filtering, Long page, Long pageSize, List<String> fields,
      final ApiCallback<PagesGetResponse> callback) throws ApiException {
