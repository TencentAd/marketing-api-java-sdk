...
public class PagesApi {
   ...
   */
  public com.squareup.okhttp.Call pagesGetCall(
      Long accountId,
  ...
  private com.squareup.okhttp.Call pagesGetValidateBeforeCall(
      Long accountId,
      String promotedObjectType,
      List<FilteringStruct> filtering,
      Long page,
  ...
  public PagesGetResponse pagesGet(
    ...
    ApiResponse<PagesGetResponse> resp =
        pagesGetWithHttpInfo(
            accountId, promotedObjectType, filtering, page, pageSize, fields, headerPair);
    return resp.getData();
  }
   ...
   */
  public com.squareup.okhttp.Call pagesGetAsync(
      Long accountId,
      String promotedObjectType,
      List<FilteringStruct> filtering,
      Long page,
