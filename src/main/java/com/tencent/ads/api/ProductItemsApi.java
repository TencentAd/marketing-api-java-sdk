...
public class ProductItemsApi {
   ...
   */
  public com.squareup.okhttp.Call productItemsAddCall(ProductItemsAddRequest data,
  ...
  private com.squareup.okhttp.Call productItemsAddValidateBeforeCall(ProductItemsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<ProductItemsAddResponse> productItemsAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<ProductItemsAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call productItemsAddAsync(ProductItemsAddRequest data,
      final ApiCallback<ProductItemsAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<ProductItemsAddResponse>() {
    }.getType();
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call productItemsGetCall(Long accountId, Long productCatalogId,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call productItemsGetValidateBeforeCall(Long accountId,
      Long productCatalogId, List<FilteringStruct> filtering, List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsGetCall(accountId, productCatalogId, filtering,
   ...
   * response body
   */
  public ProductItemsGetResponse productItemsGet(Long accountId, Long productCatalogId,
      List<FilteringStruct> filtering, List<String> fields) throws ApiException {
    ApiResponse<ProductItemsGetResponse> resp = productItemsGetWithHttpInfo(accountId,
        productCatalogId, filtering, fields);
    return resp.getData();
  }
   ...
   * response body
   */
  public ApiResponse<ProductItemsGetResponse> productItemsGetWithHttpInfo(Long accountId,
      Long productCatalogId, List<FilteringStruct> filtering, List<String> fields)
      throws ApiException {
    com.squareup.okhttp.Call call = productItemsGetValidateBeforeCall(accountId, productCatalogId,
        filtering, fields, null, null);
    Type localVarReturnType = new TypeToken<ProductItemsGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call productItemsGetAsync(Long accountId, Long productCatalogId,
      List<FilteringStruct> filtering, List<String> fields,
      final ApiCallback<ProductItemsGetResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsGetValidateBeforeCall(accountId, productCatalogId,
        filtering, fields, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ProductItemsGetResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call productItemsUpdateCall(ProductItemsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    Object localVarPostBody = data;
  ...
  private com.squareup.okhttp.Call productItemsUpdateValidateBeforeCall(
      ProductItemsUpdateRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsUpdateCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<ProductItemsUpdateResponse> productItemsUpdateWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<ProductItemsUpdateResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call productItemsUpdateAsync(ProductItemsUpdateRequest data,
      final ApiCallback<ProductItemsUpdateResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = productItemsUpdateValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<ProductItemsUpdateResponse>() {
    }.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
