...
public class BrandApi {
   ...
   */
  public com.squareup.okhttp.Call brandAddCall(Long accountId, String name, File brandImageFile,
    ...
    if (brandImageFile != null) {
      localVarFormParams.put("brand_image_file", brandImageFile);
    }
  ...
  private com.squareup.okhttp.Call brandAddValidateBeforeCall(Long accountId, String name,
      File brandImageFile, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = brandAddCall(accountId, name, brandImageFile, progressListener,
        progressRequestListener);
    return call;
   ...
   * response body
   */
  public ApiResponse<BrandAddResponse> brandAddWithHttpInfo(Long accountId, String name,
      File brandImageFile) throws ApiException {
    com.squareup.okhttp.Call call = brandAddValidateBeforeCall(accountId, name, brandImageFile,
        null, null);
    Type localVarReturnType = new TypeToken<BrandAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call brandAddAsync(Long accountId, String name, File brandImageFile,
      final ApiCallback<BrandAddResponse> callback) throws ApiException {
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public com.squareup.okhttp.Call brandGetCall(Long accountId, Long page, Long pageSize,
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call brandGetValidateBeforeCall(Long accountId, Long page,
    ...
    com.squareup.okhttp.Call call = brandGetCall(accountId, page, pageSize, fields,
        progressListener, progressRequestListener);
    return call;
   ...
   * response body
   */
  public ApiResponse<BrandGetResponse> brandGetWithHttpInfo(Long accountId, Long page,
      Long pageSize, List<String> fields) throws ApiException {
    com.squareup.okhttp.Call call = brandGetValidateBeforeCall(accountId, page, pageSize, fields,
        null, null);
    Type localVarReturnType = new TypeToken<BrandGetResponse>() {
    }.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call brandGetAsync(Long accountId, Long page, Long pageSize,
      List<String> fields, final ApiCallback<BrandGetResponse> callback) throws ApiException {
