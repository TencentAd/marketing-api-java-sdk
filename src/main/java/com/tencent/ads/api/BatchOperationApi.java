...
public class BatchOperationApi {
   ...
   */
  public com.squareup.okhttp.Call batchOperationAddCall(BatchOperationAddRequest data,
  ...
  private com.squareup.okhttp.Call batchOperationAddValidateBeforeCall(
      BatchOperationAddRequest data, final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    com.squareup.okhttp.Call call = batchOperationAddCall(data, progressListener,
        progressRequestListener);
    return call;
  ...
  public ApiResponse<BatchOperationAddResponse> batchOperationAddWithHttpInfo(
    ...
    Type localVarReturnType = new TypeToken<BatchOperationAddResponse>() {
    }.getType();
   ...
   */
  public com.squareup.okhttp.Call batchOperationAddAsync(BatchOperationAddRequest data,
      final ApiCallback<BatchOperationAddResponse> callback) throws ApiException {
    ...
    com.squareup.okhttp.Call call = batchOperationAddValidateBeforeCall(data, progressListener,
        progressRequestListener);
    Type localVarReturnType = new TypeToken<BatchOperationAddResponse>() {
    }.getType();
