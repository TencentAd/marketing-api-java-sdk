...
public class CustomAudiencesApiContainer extends ApiContainer {
   ...
   * response body
   */
  public CustomAudiencesGetResponseData customAudiencesGet(Long accountId, Long audienceId,
      Long page, Long pageSize, String platform, List<String> fields) throws ApiException {
    CustomAudiencesGetResponse resp = api
