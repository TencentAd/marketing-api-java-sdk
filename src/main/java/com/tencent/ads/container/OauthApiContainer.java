...
public class OauthApiContainer extends ApiContainer {
  ...
  public String oauthAuthorize(Long clientId, String redirectUri, String state, String scope,
    ...
    String resp = api
        .oauthAuthorize(clientId, redirectUri, state, scope, accountType, accountDisplayNumber,
            fields);
   ...
   */
  @NeedDiffHost
  public OauthTokenResponseData oauthToken(Long clientId, String clientSecret, String grantType,
      String authorizationCode, String refreshToken, String redirectUri) throws ApiException {
    OauthTokenResponse resp = api
        .oauthToken(clientId, clientSecret, grantType, authorizationCode, refreshToken,
            redirectUri);
