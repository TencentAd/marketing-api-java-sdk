...
public class AdcreativesApiContainer extends ApiContainer {
   ...
   * response body
   */
  public AdcreativesAddResponseData adcreativesAdd(AdcreativesAddRequest data) throws ApiException {
   ...
   * response body
   */
  public AdcreativesGetResponseData adcreativesGet(Long accountId, List<FilteringStruct> filtering,
      Long page, Long pageSize, Boolean isDeleted, List<String> fields) throws ApiException {
    AdcreativesGetResponse resp = api
