...
public class CustomAudienceInsightsApiContainer extends ApiContainer {
   ...
   * response body
   */
  public CustomAudienceInsightsGetResponseData customAudienceInsightsGet(Long accountId,
      Long audienceId, List<String> dimensionType, List<String> fields) throws ApiException {
    CustomAudienceInsightsGetResponse resp = api
