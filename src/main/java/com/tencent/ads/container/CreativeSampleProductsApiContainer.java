...
public class CreativeSampleProductsApiContainer extends ApiContainer {
  ...
  public CreativeSampleProductsGetResponseData creativeSampleProductsGet(
      CreativeSampleProductsGetRequest data) throws ApiException, TencentAdsResponseException {
    CreativeSampleProductsGetResponse resp = api.creativeSampleProductsGet(data);
