...
public class SplitTestsApiContainer extends ApiContainer {
   ...
   * response body
   */
  public SplitTestsAddResponseData splitTestsAdd(SplitTestsAddRequest data) throws ApiException {
   ...
   * response body
   */
  public SplitTestsGetResponseData splitTestsGet(Long accountId, List<FilteringStruct> filtering,
