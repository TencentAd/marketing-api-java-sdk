...
public class TargetingTagReportsApiContainer extends ApiContainer {
   ...
   * response body
   */
  public TargetingTagReportsGetResponseData targetingTagReportsGet(Long accountId, String type,
    ...
    TargetingTagReportsGetResponse resp = api
        .targetingTagReportsGet(accountId, type, level, dateRange, posType, filtering, groupBy,
            orderBy, page, pageSize, timeLine, fields);
