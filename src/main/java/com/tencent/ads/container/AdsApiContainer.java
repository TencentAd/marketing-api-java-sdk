...
public class AdsApiContainer extends ApiContainer {
   ...
   * response body
   */
  public AdsAddResponseData adsAdd(AdsAddRequest data) throws ApiException {
   ...
   * response body
   */
  public AdsDeleteResponseData adsDelete(AdsDeleteRequest data) throws ApiException {
   ...
   * response body
   */
  public AdsGetResponseData adsGet(Long accountId, List<FilteringStruct> filtering, Long page,
   ...
   * response body
   */
  public AdsUpdateResponseData adsUpdate(AdsUpdateRequest data) throws ApiException {
