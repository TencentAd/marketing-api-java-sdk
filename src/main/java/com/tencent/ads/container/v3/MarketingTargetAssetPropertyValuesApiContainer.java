...
public class MarketingTargetAssetPropertyValuesApiContainer extends ApiContainer {
  ...
  @Inject MarketingTargetAssetPropertyValuesApi api;
   ...
   *     response body
   */
  public MarketingTargetAssetPropertyValuesGetResponseData marketingTargetAssetPropertyValuesGet(
      Long organizationId,
    ...
    MarketingTargetAssetPropertyValuesGetResponse resp =
        api.marketingTargetAssetPropertyValuesGet(
            organizationId,
            marketingTargetType,
            marketingAssetType,
