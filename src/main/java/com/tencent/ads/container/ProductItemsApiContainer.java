...
public class ProductItemsApiContainer extends ApiContainer {
   ...
   * response body
   */
  public ProductItemsGetResponseData productItemsGet(Long accountId, Long productCatalogId,
      List<FilteringStruct> filtering, List<String> fields) throws ApiException {
    ProductItemsGetResponse resp = api
        .productItemsGet(accountId, productCatalogId, filtering, fields);
    handleResponse(gson.toJson(resp));
    return resp.getData();
  }
