...
public class AuthorizeOauth {
  ...
  public OauthAuthorizeResponseData authorizeOauth() throws Exception {
    OauthAuthorizeResponseData response =
  ...
  public static void main(String[] args) {
    try {
      ...
      authorizeOauth.init();
      OauthAuthorizeResponseData response = authorizeOauth.authorizeOauth();
