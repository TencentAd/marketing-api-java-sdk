...
public class AddJointBudgetRules {
  ...
  public JointBudgetRulesAddResponseData addJointBudgetRules() throws Exception {
    JointBudgetRulesAddResponseData response =
        tencentAds.jointBudgetRules().jointBudgetRulesAdd(data);
    return response;
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      JointBudgetRulesAddResponseData response = addJointBudgetRules.addJointBudgetRules();
