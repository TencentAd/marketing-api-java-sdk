...
public class AddAdcreativePreviews {
  ...
  public AdcreativePreviewsAddResponseData addAdcreativePreviews() throws Exception {
    AdcreativePreviewsAddResponseData response =
  ...
  public static void main(String[] args) {
    try {
      ...
      AdcreativePreviewsAddResponseData response = addAdcreativePreviews.addAdcreativePreviews();
