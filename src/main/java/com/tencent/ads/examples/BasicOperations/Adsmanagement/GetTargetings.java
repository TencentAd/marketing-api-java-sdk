...
public class GetTargetings {
  ...
  public List<String> fields = Arrays.asList("targeting_id", "targeting_name");
  ...
  public TargetingsGetResponseData getTargetings() throws Exception {
    TargetingsGetResponseData response =
        tencentAds.targetings().targetingsGet(accountId, filtering, page, pageSize, fields);
    return response;
  }
