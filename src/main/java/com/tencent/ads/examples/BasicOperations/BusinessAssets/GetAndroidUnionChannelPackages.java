...
public class GetAndroidUnionChannelPackages {
  ...
  public AndroidUnionChannelPackagesGetResponseData getAndroidUnionChannelPackages()
      throws Exception {
  ...
  public static void main(String[] args) {
    try {
      GetAndroidUnionChannelPackages getAndroidUnionChannelPackages =
          new GetAndroidUnionChannelPackages();
      getAndroidUnionChannelPackages.init();
      AndroidUnionChannelPackagesGetResponseData response =
          getAndroidUnionChannelPackages.getAndroidUnionChannelPackages();
