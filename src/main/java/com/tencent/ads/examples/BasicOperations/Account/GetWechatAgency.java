...
public class GetWechatAgency {
  ...
  public WechatAgencyGetResponseData getWechatAgency() throws Exception {
    WechatAgencyGetResponseData response =
        tencentAds.wechatAgency().wechatAgencyGet(accountId, fields);
    return response;
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      WechatAgencyGetResponseData response = getWechatAgency.getWechatAgency();
