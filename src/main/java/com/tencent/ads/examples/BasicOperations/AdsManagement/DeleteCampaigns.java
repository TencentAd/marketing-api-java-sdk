...
public class DeleteCampaigns {
  ...
  public CampaignsDeleteRequest data = new CampaignsDeleteRequest();
  ...
  public CampaignsDeleteResponseData deleteCampaigns() throws Exception {
  ...
  public static void main(String[] args) {
    try {
      ...
      CampaignsDeleteResponseData response = deleteCampaigns.deleteCampaigns();
