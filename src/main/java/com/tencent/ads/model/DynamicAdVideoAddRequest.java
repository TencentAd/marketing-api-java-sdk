...
public class DynamicAdVideoAddRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, productCatalogId, productMode, productSource, videoMaxDuration,
        dynamicAdTemplateId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DynamicAdVideoAddRequest {\n");
    ...
    sb.append("    videoMaxDuration: ").append(toIndentedString(videoMaxDuration)).append("\n");
