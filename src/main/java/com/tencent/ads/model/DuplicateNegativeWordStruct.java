...
@ApiModel(description = "否定词重复而导致失败的否定词列表，包括请求的否定词之间重复、请求的否定词和已有否定词重复、否定词和广告组中关键词重复等")
public class DuplicateNegativeWordStruct {
  ...
  public DuplicateNegativeWordStruct phraseNegativeWords(List<String> phraseNegativeWords) {
    this.phraseNegativeWords = phraseNegativeWords;
    return this;
  }

  public DuplicateNegativeWordStruct addPhraseNegativeWordsItem(String phraseNegativeWordsItem) {
  ...
  public DuplicateNegativeWordStruct exactNegativeWords(List<String> exactNegativeWords) {
    this.exactNegativeWords = exactNegativeWords;
    return this;
  }

  public DuplicateNegativeWordStruct addExactNegativeWordsItem(String exactNegativeWordsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DuplicateNegativeWordStruct duplicateNegativeWordStruct = (DuplicateNegativeWordStruct) o;
    return Objects.equals(this.phraseNegativeWords, duplicateNegativeWordStruct.phraseNegativeWords)
        && Objects.equals(this.exactNegativeWords, duplicateNegativeWordStruct.exactNegativeWords);
  }
