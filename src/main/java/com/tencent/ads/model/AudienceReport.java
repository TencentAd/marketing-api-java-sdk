...
public class AudienceReport {
  ...
  public int hashCode() {
    return Objects
        .hash(audienceId, accountId, adgroupId, campaignId, wechatAdgroupId, wechatCampaignId,
            modelId, audiencePredictTaskId, actionType, cost, actionCount, userCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class AudienceReport {\n");
    ...
    sb.append("    audiencePredictTaskId: ").append(toIndentedString(audiencePredictTaskId))
        .append("\n");
