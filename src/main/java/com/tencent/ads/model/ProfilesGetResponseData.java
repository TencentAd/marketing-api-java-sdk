...
public class ProfilesGetResponseData {

  @SerializedName("list")
  private List<ProfilesGetListStruct> list = null;
  ...
  public ProfilesGetResponseData addListItem(ProfilesGetListStruct listItem) {
    if (this.list == null) {
      this.list = new ArrayList<ProfilesGetListStruct>();
    }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProfilesGetResponseData profilesGetResponseData = (ProfilesGetResponseData) o;
    return Objects.equals(this.list, profilesGetResponseData.list) &&
        Objects.equals(this.pageInfo, profilesGetResponseData.pageInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProfilesGetResponseData {\n");
