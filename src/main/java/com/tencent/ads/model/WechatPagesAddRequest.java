...
public class WechatPagesAddRequest {
  ...
  public int hashCode() {
    return Objects
        .hash(pageName, pageTemplateId, shareContentSpec, accountId, pageElementsSpecList);
  }
  ...
  public String toString() {
    ...
    sb.append("class WechatPagesAddRequest {\n");

    sb.append("    pageName: ").append(toIndentedString(pageName)).append("\n");
    sb.append("    pageTemplateId: ").append(toIndentedString(pageTemplateId)).append("\n");
    sb.append("    shareContentSpec: ").append(toIndentedString(shareContentSpec)).append("\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    pageElementsSpecList: ").append(toIndentedString(pageElementsSpecList))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
