...
public enum TaskType {
  ...
  TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG(
      "TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG"),
  ...
  TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW(
      "TASK_TYPE_UPDATE_EXCLUDE_UNION_POSITION_PACKAGE_NEW"),

  TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW(
      "TASK_TYPE_UPDATE_DEEP_CONVERSION_BEHAVIOR_BID_NEW"),
  ...
  TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW(
      "TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW"),

  TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW("TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW"),

  TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW(
      "TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW"),
  ...
  TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW(
      "TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW"),
  ...
  TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW(
      "TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW"),
  ...
  TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION(
      "TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION"),
  ...
  TASK_TYPE_DOWNLOAD_UNBIND_COMPONENT_RESULT_DETAIL(
      "TASK_TYPE_DOWNLOAD_UNBIND_COMPONENT_RESULT_DETAIL"),
  ...
  TASK_TYPE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW(
      "TASK_TYPE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW"),
  ...
  TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_SUB_TASK(
      "TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_SUB_TASK"),
  ...
  TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK"),
  ...
  TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK(
      "TASK_TYPE_UPDATE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK"),
  ...
  TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_BID_AMOUNT_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_BIND_RTA_POLICY_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_FINDER_OBJECT_COMMENT_FLAG_NEW_SUB_TASK"),

  TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW_SUB_TASK(
      "TASK_TYPE_REPLY_FINDER_OBJECT_COMMENT_NEW_SUB_TASK"),

  TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW_SUB_TASK(
      "TASK_TYPE_DELETE_FINDER_OBJECT_COMMENT_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADCREATIVE_OBJECT_COMMENT_FLAG_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_CONFIGURED_STATUS_NEW_SUB_TASK"),

  TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW_SUB_TASK("TASK_TYPE_DELETE_DYNAMIC_CREATIVE_NEW_SUB_TASK"),

  TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW_SUB_TASK(
      "TASK_TYPE_PROCESS_USER_PAGE_OBJECT_NEW_SUB_TASK"),

  TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK(
      "TASK_TYPE_CREATE_SCHEDULED_UPDATE_ADGROUP_DAILY_BUDGET_NEW_SUB_TASK"),

  TASK_TYPE_DELETE_SCHEDULED_TASK_NEW_SUB_TASK("TASK_TYPE_DELETE_SCHEDULED_TASK_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_ECOM_PKAM_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_DERIVE_CONF_NEW_SUB_TASK"),

  TASK_TYPE_UPDATE_COMPONENT_SHARED_SUB_TASK("TASK_TYPE_UPDATE_COMPONENT_SHARED_SUB_TASK"),

  TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL_SUB_TASK(
      "TASK_TYPE_UPDATE_ADGROUP_SMART_DELIVERY_GOAL_SUB_TASK"),

  TASK_TYPE_DELETE_ACCOUNT_COMPONENT_SUB_TASK("TASK_TYPE_DELETE_ACCOUNT_COMPONENT_SUB_TASK"),

  TASK_TYPE_DELETE_ORGANIZATION_COMPONENT_SUB_TASK(
      "TASK_TYPE_DELETE_ORGANIZATION_COMPONENT_SUB_TASK"),
  ...
  TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK(
      "TASK_TYPE_UPDATE_DYNAMIC_CREATIVE_SEARCH_INTELLIGENT_EXTENSION_SUB_TASK"),

  TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC_SUB_TASK(
      "TASK_TYPE_UNBIND_COMPONENT_OR_SUSPEND_DC_SUB_TASK"),
  ...
  TASK_TYPE_SEARCH_INDUSTRY_TRAFFIC_ANALYSIS_DATA_DOWNLOAD(
      "TASK_TYPE_SEARCH_INDUSTRY_TRAFFIC_ANALYSIS_DATA_DOWNLOAD"),

  TASK_TYPE_SEARCH_QUERY_WORD_TRAFFIC_ANALYSIS_DATA_DOWNLOAD(
      "TASK_TYPE_SEARCH_QUERY_WORD_TRAFFIC_ANALYSIS_DATA_DOWNLOAD"),
