...
public class ProfilesGetListStruct {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(profileType, profileId, promotedObjectType, promotedObjectId, headImageId,
        profileName, description, createdTime, lastModifiedTime, profileUrl, systemStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProfilesGetListStruct {\n");
