...
public class AuthorizerStruct {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountUin, accountId, scopeList, wechatAccountId, accountRoleType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizerStruct {\n");

    sb.append("    accountUin: ").append(toIndentedString(accountUin)).append("\n");
    ...
    sb.append("    accountRoleType: ").append(toIndentedString(accountRoleType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
