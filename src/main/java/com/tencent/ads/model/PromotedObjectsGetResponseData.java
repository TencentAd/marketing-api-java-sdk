...
public class PromotedObjectsGetResponseData {

  @SerializedName("list")
  private List<PromotedObjectsGetListStruct> list = null;
  ...
  public PromotedObjectsGetResponseData addListItem(PromotedObjectsGetListStruct listItem) {
    if (this.list == null) {
      this.list = new ArrayList<PromotedObjectsGetListStruct>();
    }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PromotedObjectsGetResponseData promotedObjectsGetResponseData = (PromotedObjectsGetResponseData) o;
    return Objects.equals(this.list, promotedObjectsGetResponseData.list) &&
        Objects.equals(this.pageInfo, promotedObjectsGetResponseData.pageInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotedObjectsGetResponseData {\n");
