...
public class AdsUpdateResponse {
  ...
  @SerializedName("data")
  private AdsUpdateResponseData data = null;

  public AdsUpdateResponse code(Long code) {
    this.code = code;
    return this;
  }
  ...
  public AdsUpdateResponse message(String message) {
  ...
  public AdsUpdateResponse messageCn(String messageCn) {
  ...
  public AdsUpdateResponse errors(List<ApiErrorStruct> errors) {
    this.errors = errors;
    return this;
  }

  public AdsUpdateResponse addErrorsItem(ApiErrorStruct errorsItem) {
    if (this.errors == null) {
  ...
  public AdsUpdateResponse data(AdsUpdateResponseData data) {
    this.data = data;
    return this;
  }
   ...
   **/
  @ApiModelProperty(value = "")
  public AdsUpdateResponseData getData() {
    return data;
  }

  public void setData(AdsUpdateResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdsUpdateResponse adsUpdateResponse = (AdsUpdateResponse) o;
  ...
  public String toString() {
    ...
    sb.append("class AdsUpdateResponse {\n");
