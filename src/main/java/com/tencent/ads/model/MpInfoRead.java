...
public class MpInfoRead {
  ...
  public int hashCode() {
    return Objects
        .hash(wechatAccountId, wechatAccountName, systemStatus, industryName, contactPerson,
            contactPersonTelephone, businessType, businessContent, rejectMessage, profilePhoto,
            brandIntroduction, introductionUrl, systemIndustryId);
  }
