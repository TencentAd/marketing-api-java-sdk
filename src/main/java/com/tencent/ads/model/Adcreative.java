...
public class Adcreative {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adcreativeId, adcreativeName, campaignId, pageType, pageSpec, siteSet,
        promotedObjectType, promotedObjectId, createdTime, lastModifiedTime, playablePageMaterialId,
