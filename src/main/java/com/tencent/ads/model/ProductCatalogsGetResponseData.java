...
public class ProductCatalogsGetResponseData {

  @SerializedName("list")
  private List<ProductCatalogsGetListStruct> list = null;
  ...
  public ProductCatalogsGetResponseData addListItem(ProductCatalogsGetListStruct listItem) {
    if (this.list == null) {
      this.list = new ArrayList<ProductCatalogsGetListStruct>();
    }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProductCatalogsGetResponseData productCatalogsGetResponseData = (ProductCatalogsGetResponseData) o;
    return Objects.equals(this.list, productCatalogsGetResponseData.list) &&
        Objects.equals(this.pageInfo, productCatalogsGetResponseData.pageInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductCatalogsGetResponseData {\n");
