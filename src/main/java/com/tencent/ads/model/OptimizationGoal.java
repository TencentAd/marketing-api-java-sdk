...
/**
 * 广告优化目标类型。目前OPTIMIZATIONGOAL_LEADS_COLLECT、OPTIMIZATIONGOAL_APPLY、OPTIMIZATIONGOAL_PRE_CREDIT、OPTIMIZATIONGOAL_CREDIT、OPTIMIZATIONGOAL_WITHDRAW_DEPOSITS、OPTIMIZATIONGOAL_PURCHASE_MEMBER_CARD等六个目标灰度开放中
 */
