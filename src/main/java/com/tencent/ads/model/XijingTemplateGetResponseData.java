...
public class XijingTemplateGetResponseData {
  ...
  public XijingTemplateGetResponseData componentSpecList(List<String> componentSpecList) {
    this.componentSpecList = componentSpecList;
    return this;
  }

  public XijingTemplateGetResponseData addComponentSpecListItem(String componentSpecListItem) {
  ...
  public int hashCode() {
    return Objects.hash(
        pageTemplateId, pageType, pageName, pageTitle, componentSpecList, mobileAppId);
  }
