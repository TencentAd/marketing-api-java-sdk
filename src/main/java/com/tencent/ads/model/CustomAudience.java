...
public class CustomAudience {
  ...
  public int hashCode() {
    return Objects
        .hash(audienceId, accountId, name, outerAudienceId, description, type, status, errorCode,
            userCount, createdTime, lastModifiedTime, audienceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomAudience {\n");
