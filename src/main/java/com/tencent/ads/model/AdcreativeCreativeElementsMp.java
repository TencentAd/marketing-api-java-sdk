...
public class AdcreativeCreativeElementsMp {
  ...
  public AdcreativeCreativeElementsMp image(Long image) {
    this.image = image;
    return this;
  }
  ...
  public AdcreativeCreativeElementsMp image2(Long image2) {
    this.image2 = image2;
    return this;
  }
  ...
  public AdcreativeCreativeElementsMp image3(Long image3) {
    this.image3 = image3;
    return this;
  }
  ...
  public AdcreativeCreativeElementsMp video(Long video) {
    this.video = video;
    return this;
  }
  ...
  public AdcreativeCreativeElementsMp linkNameType(LinkNameTypeMP linkNameType) {
  ...
  public AdcreativeCreativeElementsMp imageList(List<Long> imageList) {
    this.imageList = imageList;
    return this;
  }

  public AdcreativeCreativeElementsMp addImageListItem(Long imageListItem) {
  ...
  public AdcreativeCreativeElementsMp label(List<AdcreativeLabel> label) {
    this.label = label;
    return this;
  }

  public AdcreativeCreativeElementsMp addLabelItem(AdcreativeLabel labelItem) {
    if (this.label == null) {
  ...
  public int hashCode() {
    return Objects
        .hash(image, image2, image3, title, description, corporate, video, linkNameType, imageList,
            elementStory, url, buttonText, bottomText, label, productTags, logoDescription, logo,
            leftBottomTxt, animationEffect, phone, shortVideoStruct, longVideoStruct, bannerContent,
            cardContent, videoPopupButton, brand, caption, labelledImg, fullScreenImage, zipUrl,
            endPage, countdownExpiringTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdcreativeCreativeElementsMp {\n");
