...
public class KeywordSpec {
  ...
  public String toString() {
    ...
    sb.append("class KeywordSpec {\n");

    sb.append("    includeKeyword: ").append(toIndentedString(includeKeyword)).append("\n");
    sb.append("    excludeKeyword: ").append(toIndentedString(excludeKeyword)).append("\n");
    sb.append("}");
    return sb.toString();
  }
