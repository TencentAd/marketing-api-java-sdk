...
public class ElementButtonRead {
  ...
  public int hashCode() {
    return Objects
        .hash(title, url, appIosSpec, appAndroidSpec, miniProgramSpec, miniGameProgramSpec,
            fengyeSpec, cardSpec, followSpec, serviceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElementButtonRead {\n");
