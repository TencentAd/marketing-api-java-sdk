...
public class DataFile {
  ...
  public int hashCode() {
    return Objects
        .hash(audienceId, customAudienceFileId, name, userIdType, operationType, openAppId, saltId,
            processStatus, processCode, errorMessage, lineCount, validLineCount, userCount, size,
            createdTime);
  }
