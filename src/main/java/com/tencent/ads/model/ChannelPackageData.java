...
public class ChannelPackageData {
  ...
  public int hashCode() {
    return Objects
        .hash(androidAppId, packageName, channelPackageId, versionCode, versionName, createdTime,
            lastModifiedTime, systemStatus, auditStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelPackageData {\n");
