...
public class PropertiesUserId {
  ...
  public int hashCode() {
    return Objects
        .hash(hashQq, hashPhone, hashIdfa, hashImei, hashMac, wechatOpenid, wechatUnionid);
  }
  ...
  public String toString() {
    ...
    sb.append("class PropertiesUserId {\n");

    sb.append("    hashQq: ").append(toIndentedString(hashQq)).append("\n");
    ...
    sb.append("    wechatOpenid: ").append(toIndentedString(wechatOpenid)).append("\n");
