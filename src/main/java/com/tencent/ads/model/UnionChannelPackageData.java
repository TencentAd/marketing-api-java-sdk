...
public class UnionChannelPackageData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(androidUnionAppId, packageName, channelPackageId, versionCode, versionName,
        createdTime, lastModifiedTime, systemStatus, systemMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnionChannelPackageData {\n");
