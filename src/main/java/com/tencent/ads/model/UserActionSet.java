...
public class UserActionSet {
  ...
  public int hashCode() {
    return Objects
        .hash(userActionSetId, type, mobileAppId, name, description, activateStatus, createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    activateStatus: ").append(toIndentedString(activateStatus)).append("\n");
