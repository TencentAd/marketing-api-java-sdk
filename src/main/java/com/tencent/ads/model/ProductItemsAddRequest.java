...
public class ProductItemsAddRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, productCatalogId, feedId, productItemSpecList);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductItemsAddRequest {\n");

    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    productCatalogId: ").append(toIndentedString(productCatalogId)).append("\n");
    sb.append("    feedId: ").append(toIndentedString(feedId)).append("\n");
    sb.append("    productItemSpecList: ").append(toIndentedString(productItemSpecList))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
