...
public class AdsGetListStruct {
  ...
  public int hashCode() {
    return Objects
        .hash(campaignId, adgroupId, adId, adName, adcreativeId, adcreative, configuredStatus,
            systemStatus, auditSpec, impressionTrackingUrl, clickTrackingUrl,
            feedsInteractionEnabled, isDeleted, isDynamicCreative, createdTime, lastModifiedTime,
            rejectMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdsGetListStruct {\n");
    ...
    sb.append("    auditSpec: ").append(toIndentedString(auditSpec)).append("\n");
