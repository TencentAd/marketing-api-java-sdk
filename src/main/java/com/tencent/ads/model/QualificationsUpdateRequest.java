...
public class QualificationsUpdateRequest {
  ...
  public QualificationsUpdateRequest qualificationId(Long qualificationId) {
  ...
  public QualificationsUpdateRequest imageIdList(List<String> imageIdList) {
    this.imageIdList = imageIdList;
    return this;
  }

  public QualificationsUpdateRequest addImageIdListItem(String imageIdListItem) {
  ...
  public String toString() {
    ...
    sb.append("class QualificationsUpdateRequest {\n");
