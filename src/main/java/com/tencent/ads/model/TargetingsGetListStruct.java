...
public class TargetingsGetListStruct {
  ...
  public int hashCode() {
    return Objects
        .hash(targetingId, targetingName, isIncludeUnsupportedTargeting, description, isDeleted,
            createdTime, lastModifiedTime, adLockStatus, targetingTranslation, targeting);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetingsGetListStruct {\n");
    ...
    sb.append("    adLockStatus: ").append(toIndentedString(adLockStatus)).append("\n");
