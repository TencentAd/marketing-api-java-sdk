...
public class DetailedFundStatement {
  ...
  public int hashCode() {
    return Objects
        .hash(tradeType, time, amount, wechatAccountId, wechatAccountName, fundType, externalBillNo,
            description, operator, billNo, repaymentChannelType, companyName, contactName,
            contactPhone, status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetailedFundStatement {\n");
    ...
    sb.append("    repaymentChannelType: ").append(toIndentedString(repaymentChannelType))
        .append("\n");
