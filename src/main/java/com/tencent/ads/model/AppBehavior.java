...
public class AppBehavior {
  ...
  public String toString() {
    ...
    sb.append("class AppBehavior {\n");

    sb.append("    objectType: ").append(toIndentedString(objectType)).append("\n");
    sb.append("    objectIdList: ").append(toIndentedString(objectIdList)).append("\n");
    sb.append("    timeWindow: ").append(toIndentedString(timeWindow)).append("\n");
    sb.append("    actIdList: ").append(toIndentedString(actIdList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
