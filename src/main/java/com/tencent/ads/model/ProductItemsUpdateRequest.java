...
public class ProductItemsUpdateRequest {
  ...
  public int hashCode() {
    return Objects
        .hash(accountId, catalogId, productOuterId, price, salePrice, pricePc, priceMobile,
            priceApp, stockVolume, discount, expirationTime, productSaleStatus, productVisibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductItemsUpdateRequest {\n");
    ...
    sb.append("    pricePc: ").append(toIndentedString(pricePc)).append("\n");
    sb.append("    priceMobile: ").append(toIndentedString(priceMobile)).append("\n");
    sb.append("    priceApp: ").append(toIndentedString(priceApp)).append("\n");
