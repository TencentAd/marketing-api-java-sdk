...
public class BidwordAddRequest {
  ...
  @SerializedName("list")
  private List<BidwordStruct> list = null;
  ...
  public BidwordAddRequest list(List<BidwordStruct> list) {
    this.list = list;
    return this;
  }

  public BidwordAddRequest addListItem(BidwordStruct listItem) {
    if (this.list == null) {
      this.list = new ArrayList<BidwordStruct>();
    }
   ...
   */
  @ApiModelProperty(value = "")
  public List<BidwordStruct> getList() {
    return list;
  }

  public void setList(List<BidwordStruct> list) {
    this.list = list;
  }
