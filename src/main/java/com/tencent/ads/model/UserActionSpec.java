...
public class UserActionSpec {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userActionSetId, matchRuleType, extractType, timeWindow, urlMatchRule,
        actionMatchRule, actionAggregationRule);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserActionSpec {\n");

    sb.append("    userActionSetId: ").append(toIndentedString(userActionSetId)).append("\n");
    sb.append("    matchRuleType: ").append(toIndentedString(matchRuleType)).append("\n");
    ...
    sb.append("    urlMatchRule: ").append(toIndentedString(urlMatchRule)).append("\n");
    sb.append("    actionMatchRule: ").append(toIndentedString(actionMatchRule)).append("\n");
    sb.append("    actionAggregationRule: ").append(toIndentedString(actionAggregationRule))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
