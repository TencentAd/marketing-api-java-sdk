...
public class ProductItemsUpdateRequest {
  ...
  public ProductItemsUpdateRequest expirationTime(String expirationTime) {
  ...
  public ProductItemsUpdateRequest productSaleStatus(DpaProductSaleStatus productSaleStatus) {
