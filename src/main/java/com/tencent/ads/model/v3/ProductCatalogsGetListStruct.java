...
public class ProductCatalogsGetListStruct {
  ...
  public ProductCatalogsGetListStruct productCatalogType(DpaApiCatalogType productCatalogType) {
  ...
  public void setProductCatalogType(DpaApiCatalogType productCatalogType) {
    this.productCatalogType = productCatalogType;
  }
  ...
  public ProductCatalogsGetListStruct productRecommendMethods(
      List<ProductRecommendMethod> productRecommendMethods) {
    this.productRecommendMethods = productRecommendMethods;
    return this;
  }

  public ProductCatalogsGetListStruct addProductRecommendMethodsItem(
      ProductRecommendMethod productRecommendMethodsItem) {
    if (this.productRecommendMethods == null) {
      this.productRecommendMethods = new ArrayList<ProductRecommendMethod>();
    }
  ...
  public void setProductRecommendMethods(List<ProductRecommendMethod> productRecommendMethods) {
    this.productRecommendMethods = productRecommendMethods;
  }
