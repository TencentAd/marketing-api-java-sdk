...
public class AdLabelGetListStruct {
  ...
  public AdLabelGetListStruct labelStructs(List<AdLabelStruct> labelStructs) {
    this.labelStructs = labelStructs;
    return this;
  }

  public AdLabelGetListStruct addLabelStructsItem(AdLabelStruct labelStructsItem) {
    if (this.labelStructs == null) {
      this.labelStructs = new ArrayList<AdLabelStruct>();
    }
  ...
  public void setLabelStructs(List<AdLabelStruct> labelStructs) {
    this.labelStructs = labelStructs;
  }
