...
public class CompititionAnalysisDetailSpec {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.date, compititionAnalysisDetailSpec.date) &&
        ...
        Objects
            .equals(this.sameIndustryBidAmount, compititionAnalysisDetailSpec.sameIndustryBidAmount)
        &&
        ...
        Objects.equals(this.sameIndustryConversion,
            compititionAnalysisDetailSpec.sameIndustryConversion) &&
        Objects.equals(this.winOverAdConversion, compititionAnalysisDetailSpec.winOverAdConversion);
  }

  @Override
  public int hashCode() {
    return Objects
        .hash(date, hour, adUserAcceptance, adBidAmount, sameIndustryBidAmount, winOverAdBidAmount,
            adClick, sameIndustryClick, winOverAdClick, adConversion, sameIndustryConversion,
            winOverAdConversion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompititionAnalysisDetailSpec {\n");

    sb.append("    date: ").append(toIndentedString(date)).append("\n");
    sb.append("    hour: ").append(toIndentedString(hour)).append("\n");
    sb.append("    adUserAcceptance: ").append(toIndentedString(adUserAcceptance)).append("\n");
    sb.append("    adBidAmount: ").append(toIndentedString(adBidAmount)).append("\n");
    sb.append("    sameIndustryBidAmount: ").append(toIndentedString(sameIndustryBidAmount))
        .append("\n");
    sb.append("    winOverAdBidAmount: ").append(toIndentedString(winOverAdBidAmount)).append("\n");
    sb.append("    adClick: ").append(toIndentedString(adClick)).append("\n");
    sb.append("    sameIndustryClick: ").append(toIndentedString(sameIndustryClick)).append("\n");
    sb.append("    winOverAdClick: ").append(toIndentedString(winOverAdClick)).append("\n");
    sb.append("    adConversion: ").append(toIndentedString(adConversion)).append("\n");
    sb.append("    sameIndustryConversion: ").append(toIndentedString(sameIndustryConversion))
        .append("\n");
    sb.append("    winOverAdConversion: ").append(toIndentedString(winOverAdConversion))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
