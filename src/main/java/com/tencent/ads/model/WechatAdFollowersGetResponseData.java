...
public class WechatAdFollowersGetResponseData {

  @SerializedName("list")
  private List<WechatAdFollowersGetListStruct> list = null;
  ...
  public WechatAdFollowersGetResponseData addListItem(WechatAdFollowersGetListStruct listItem) {
    if (this.list == null) {
      this.list = new ArrayList<WechatAdFollowersGetListStruct>();
    }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WechatAdFollowersGetResponseData wechatAdFollowersGetResponseData = (WechatAdFollowersGetResponseData) o;
    return Objects.equals(this.list, wechatAdFollowersGetResponseData.list) &&
        Objects.equals(this.pageInfo, wechatAdFollowersGetResponseData.pageInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class WechatAdFollowersGetResponseData {\n");
