...
public class CompititionDiagnosisConclusionSpec {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CompititionDiagnosisConclusionSpec compititionDiagnosisConclusionSpec = (CompititionDiagnosisConclusionSpec) o;
    return Objects.equals(this.compititionDiagnosisScore,
        compititionDiagnosisConclusionSpec.compititionDiagnosisScore) &&
        Objects.equals(this.compititionDiagnosisResult,
            compititionDiagnosisConclusionSpec.compititionDiagnosisResult) &&
        Objects.equals(this.bidAmountDiagnosisScore,
            compititionDiagnosisConclusionSpec.bidAmountDiagnosisScore) &&
        Objects.equals(this.bidAmountDiagnosisConclusion,
            compititionDiagnosisConclusionSpec.bidAmountDiagnosisConclusion) &&
        Objects.equals(this.clickDiagnosisScore,
            compititionDiagnosisConclusionSpec.clickDiagnosisScore) &&
        Objects.equals(this.clickDiagnosisConclusion,
            compititionDiagnosisConclusionSpec.clickDiagnosisConclusion) &&
        Objects.equals(this.conversionDiagnosisScore,
            compititionDiagnosisConclusionSpec.conversionDiagnosisScore) &&
        Objects.equals(this.conversionDiagnosisConclusion,
            compititionDiagnosisConclusionSpec.conversionDiagnosisConclusion) &&
        Objects.equals(this.userAcceptanceDiagnosisScore,
            compititionDiagnosisConclusionSpec.userAcceptanceDiagnosisScore) &&
        Objects.equals(this.userAcceptanceDiagnosisConclusion,
            compititionDiagnosisConclusionSpec.userAcceptanceDiagnosisConclusion) &&
        Objects.equals(this.compititionAnalysisDetailSpecList,
  ...
  public int hashCode() {
    return Objects
        .hash(compititionDiagnosisScore, compititionDiagnosisResult, bidAmountDiagnosisScore,
            bidAmountDiagnosisConclusion, clickDiagnosisScore, clickDiagnosisConclusion,
            conversionDiagnosisScore, conversionDiagnosisConclusion, userAcceptanceDiagnosisScore,
            userAcceptanceDiagnosisConclusion, compititionAnalysisDetailSpecList);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompititionDiagnosisConclusionSpec {\n");

    sb.append("    compititionDiagnosisScore: ").append(toIndentedString(compititionDiagnosisScore))
        .append("\n");
    sb.append("    compititionDiagnosisResult: ")
        .append(toIndentedString(compititionDiagnosisResult)).append("\n");
    sb.append("    bidAmountDiagnosisScore: ").append(toIndentedString(bidAmountDiagnosisScore))
        .append("\n");
    sb.append("    bidAmountDiagnosisConclusion: ")
        .append(toIndentedString(bidAmountDiagnosisConclusion)).append("\n");
    sb.append("    clickDiagnosisScore: ").append(toIndentedString(clickDiagnosisScore))
        .append("\n");
    sb.append("    clickDiagnosisConclusion: ").append(toIndentedString(clickDiagnosisConclusion))
        .append("\n");
    sb.append("    conversionDiagnosisScore: ").append(toIndentedString(conversionDiagnosisScore))
        .append("\n");
    sb.append("    conversionDiagnosisConclusion: ")
        .append(toIndentedString(conversionDiagnosisConclusion)).append("\n");
    sb.append("    userAcceptanceDiagnosisScore: ")
        .append(toIndentedString(userAcceptanceDiagnosisScore)).append("\n");
    sb.append("    userAcceptanceDiagnosisConclusion: ")
        .append(toIndentedString(userAcceptanceDiagnosisConclusion)).append("\n");
    sb.append("    compititionAnalysisDetailSpecList: ")
        .append(toIndentedString(compititionAnalysisDetailSpecList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
