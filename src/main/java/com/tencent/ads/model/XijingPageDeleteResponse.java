...
public class XijingPageDeleteResponse {
  @SerializedName("code")
  ...
  public XijingPageDeleteResponse message(String message) {
  ...
  public XijingPageDeleteResponse messageCn(String messageCn) {
  ...
  public XijingPageDeleteResponse errors(List<ApiErrorStruct> errors) {
    this.errors = errors;
    return this;
  }

  public XijingPageDeleteResponse addErrorsItem(ApiErrorStruct errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    XijingPageDeleteResponse xijingPageDeleteResponse = (XijingPageDeleteResponse) o;
    return Objects.equals(this.code, xijingPageDeleteResponse.code)
        && Objects.equals(this.message, xijingPageDeleteResponse.message)
        && Objects.equals(this.messageCn, xijingPageDeleteResponse.messageCn)
        && Objects.equals(this.errors, xijingPageDeleteResponse.errors)
        && Objects.equals(this.data, xijingPageDeleteResponse.data);
  }
