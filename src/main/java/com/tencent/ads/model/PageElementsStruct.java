...
public class PageElementsStruct {
  ...
  public int hashCode() {
    return Objects
        .hash(elementShelf, elementFloat, elementGoods, imageSpec, videoSpec, textSpec, buttonSpec,
            formSpec, elementType);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageElementsStruct {\n");

    sb.append("    elementShelf: ").append(toIndentedString(elementShelf)).append("\n");
    sb.append("    elementFloat: ").append(toIndentedString(elementFloat)).append("\n");
    sb.append("    elementGoods: ").append(toIndentedString(elementGoods)).append("\n");
    sb.append("    imageSpec: ").append(toIndentedString(imageSpec)).append("\n");
    sb.append("    videoSpec: ").append(toIndentedString(videoSpec)).append("\n");
    sb.append("    textSpec: ").append(toIndentedString(textSpec)).append("\n");
    sb.append("    buttonSpec: ").append(toIndentedString(buttonSpec)).append("\n");
    sb.append("    formSpec: ").append(toIndentedString(formSpec)).append("\n");
