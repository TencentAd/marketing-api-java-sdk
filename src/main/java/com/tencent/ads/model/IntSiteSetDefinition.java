...
/** 投放站点集合 */
@JsonAdapter(IntSiteSetDefinition.Adapter.class)
public enum IntSiteSetDefinition {
  ...
  IntSiteSetDefinition(String value) {
    this.value = value;
  }
  ...
  public static IntSiteSetDefinition fromValue(String text) {
    for (IntSiteSetDefinition b : IntSiteSetDefinition.values()) {
  ...
  public static class Adapter extends TypeAdapter<IntSiteSetDefinition> {
    @Override
    public void write(final JsonWriter jsonWriter, final IntSiteSetDefinition enumeration)
        throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IntSiteSetDefinition read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IntSiteSetDefinition.fromValue(String.valueOf(value));
    }
  }
}
