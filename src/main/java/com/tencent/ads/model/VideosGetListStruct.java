...
public class VideosGetListStruct {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.videoId, videosGetListStruct.videoId) &&
        ...
        Objects.equals(this.imageDurationMillisecond, videosGetListStruct.imageDurationMillisecond)
        &&
  ...
  public int hashCode() {
    return Objects
        .hash(videoId, width, height, videoFrames, videoFps, videoCodec, videoBitRate, audioCodec,
            audioBitRate, fileSize, type, signature, systemStatus, description, previewUrl,
            keyFrameImageUrl, createdTime, lastModifiedTime, videoProfileName, audioSampleRate,
            maxKeyframeInterval, minKeyframeInterval, sampleAspectRatio, audioProfileName, scanType,
            imageDurationMillisecond, audioDurationMillisecond, sourceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideosGetListStruct {\n");
    ...
    sb.append("    keyFrameImageUrl: ").append(toIndentedString(keyFrameImageUrl)).append("\n");
    sb.append("    createdTime: ").append(toIndentedString(createdTime)).append("\n");
    sb.append("    lastModifiedTime: ").append(toIndentedString(lastModifiedTime)).append("\n");
    sb.append("    videoProfileName: ").append(toIndentedString(videoProfileName)).append("\n");
    sb.append("    audioSampleRate: ").append(toIndentedString(audioSampleRate)).append("\n");
    sb.append("    maxKeyframeInterval: ").append(toIndentedString(maxKeyframeInterval))
        .append("\n");
    sb.append("    minKeyframeInterval: ").append(toIndentedString(minKeyframeInterval))
        .append("\n");
    sb.append("    sampleAspectRatio: ").append(toIndentedString(sampleAspectRatio)).append("\n");
    sb.append("    audioProfileName: ").append(toIndentedString(audioProfileName)).append("\n");
    sb.append("    scanType: ").append(toIndentedString(scanType)).append("\n");
    sb.append("    imageDurationMillisecond: ").append(toIndentedString(imageDurationMillisecond))
        .append("\n");
    sb.append("    audioDurationMillisecond: ").append(toIndentedString(audioDurationMillisecond))
        .append("\n");
