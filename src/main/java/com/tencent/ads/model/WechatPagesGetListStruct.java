...
public class WechatPagesGetListStruct {
  ...
  public int hashCode() {
    return Objects
        .hash(pageId, pageName, createdTime, lastModifiedTime, pageTemplateId, shareContentSpec,
            previewUrl, pageType, sourceType, pageElementsSpecList);
  }
  ...
  public String toString() {
    ...
    sb.append("class WechatPagesGetListStruct {\n");
