...
public class DataSourceAddResponse {
  @SerializedName("code")
  ...
  public DataSourceAddResponse message(String message) {
  ...
  public DataSourceAddResponse messageCn(String messageCn) {
  ...
  public DataSourceAddResponse errors(List<ApiErrorStruct> errors) {
    this.errors = errors;
    return this;
  }

  public DataSourceAddResponse addErrorsItem(ApiErrorStruct errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DataSourceAddResponse dataSourceAddResponse = (DataSourceAddResponse) o;
