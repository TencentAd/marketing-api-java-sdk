...
public class SubMethod {
  ...
  public String toString() {
    ...
    sb.append("class SubMethod {\n");

    sb.append("    subMethodId: ").append(toIndentedString(subMethodId)).append("\n");
    sb.append("    subMethodName: ").append(toIndentedString(subMethodName)).append("\n");
    sb.append("    subMethodDescription: ").append(toIndentedString(subMethodDescription))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
