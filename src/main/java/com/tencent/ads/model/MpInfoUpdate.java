...
/**
 * &lt;p&gt;微信广告开户信息，当输入参数 account_id 不为空时使用， 用于微信公众号开通微信广告业务(需提前绑定公众号），或开通微信通用账号业务，其中通用账号能力为邀请制开放。&lt;/p&gt;&lt;li&gt;公众号开通广告业务：绑定公众号后，如绑定的微信公众账号尚未开通广告服务，可通过填写该结构进行开通，其中
 * system_industry_id、contact_person、contact_person_telephone 必填。&lt;/li&gt;&lt;li&gt;通用账号业务：除business_type，business_content字段外，均为必填字段。&lt;/li&gt;&lt;li&gt;账号信息修改：可通过填写该结构进行信息修正，但当且仅当微信广告信息审核拒绝时，才允许进行更新&lt;/li&gt;
 */
...
public class MpInfoUpdate {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(systemIndustryId, contactPerson, contactPersonTelephone, businessType,
        businessContent, name, profilePhoto, brandIntroduction, introductionUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("    businessContent: ").append(toIndentedString(businessContent)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    profilePhoto: ").append(toIndentedString(profilePhoto)).append("\n");
    sb.append("    brandIntroduction: ").append(toIndentedString(brandIntroduction)).append("\n");
