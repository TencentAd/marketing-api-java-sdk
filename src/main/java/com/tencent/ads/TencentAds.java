 ...
 *
 */
public class TencentAds extends App {
  ...
  private static String basePath = "https://sandbox-api.e.qq.com/v1.2";
  ...
  public void init(ApiContextConfig apiContextConfig) {
    ...
    if (apiContextConfig.getAccessToken() != null && !apiContextConfig.getAccessToken()
        .equals("")) {
  ...
  public void useProduction() {
    basePath = "https://api.e.qq.com/v1.2";
    this.setHost(basePath);
  }
  ...
  private void addDefaultHeader() {
    ...
    monitorHeader.put("X-SDK-LANGUAGE-VERSION",
